...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Logout Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LogoutElementImpl extends AuthenticationElementImpl implements LogoutElement {
	...
	protected EClass eStaticClass() {
		return SecurityPackage.Literals.LOGOUT_ELEMENT;
	}
	...
	public LocalAuthenticationSystem getAuthentication() {
		if (eContainerFeatureID() != SecurityPackage.LOGOUT_ELEMENT__AUTHENTICATION) return null;
	...
	public NotificationChain basicSetAuthentication(LocalAuthenticationSystem newAuthentication, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAuthentication, SecurityPackage.LOGOUT_ELEMENT__AUTHENTICATION, msgs);
		return msgs;
	}
	...
	public void setAuthentication(LocalAuthenticationSystem newAuthentication) {
		if (newAuthentication != eInternalContainer() || (eContainerFeatureID() != SecurityPackage.LOGOUT_ELEMENT__AUTHENTICATION && newAuthentication != null)) {
			...
			if (newAuthentication != null)
				msgs = ((InternalEObject)newAuthentication).eInverseAdd(this, SecurityPackage.LOCAL_AUTHENTICATION_SYSTEM__LOGOUT_ELEMENT, LocalAuthenticationSystem.class, msgs);
			msgs = basicSetAuthentication(newAuthentication, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.LOGOUT_ELEMENT__AUTHENTICATION, newAuthentication, newAuthentication));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SecurityPackage.LOGOUT_ELEMENT__AUTHENTICATION:
				return eInternalContainer().eInverseRemove(this, SecurityPackage.LOCAL_AUTHENTICATION_SYSTEM__LOGOUT_ELEMENT, LocalAuthenticationSystem.class, msgs);
		}
