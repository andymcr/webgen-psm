...
import work.andycarpenter.psms.waf.FeatureSupportAction;
import work.andycarpenter.psms.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.psms.waf.FeatureSupportAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureSupportActionItemProvider extends InlineActionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WafPackage.Literals.FEATURE_SUPPORT_ACTION__SUCCESS_MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WafPackage.Literals.FEATURE_SUPPORT_ACTION__FAILURE_MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeatureSupportAction.class)) {
			...
			case WafPackage.FEATURE_SUPPORT_ACTION__SUCCESS_MESSAGE:
			case WafPackage.FEATURE_SUPPORT_ACTION__FAILURE_MESSAGE:
