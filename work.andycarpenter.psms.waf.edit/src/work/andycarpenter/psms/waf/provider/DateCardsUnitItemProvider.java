...
import work.andycarpenter.psms.waf.DateCardsUnit;
import work.andycarpenter.psms.waf.WafFactory;
import work.andycarpenter.psms.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.psms.waf.DateCardsUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateCardsUnitItemProvider extends CardsUnitItemProvider {
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DateCardsUnit.class)) {
			case WafPackage.DATE_CARDS_UNIT__ELEMENT_DATE:
