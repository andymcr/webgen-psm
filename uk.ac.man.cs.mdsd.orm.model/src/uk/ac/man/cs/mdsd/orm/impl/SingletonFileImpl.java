...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Singleton File</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.orm.impl.SingletonFileImpl#getMaximumUploadSize <em>Maximum Upload Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.orm.impl.SingletonFileImpl#getValidUploadMimeTypes <em>Valid Upload Mime Types</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.orm.impl.SingletonFileImpl#getValidUploadExtensions <em>Valid Upload Extensions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.orm.impl.SingletonFileImpl#isUploadsWithinWebsite <em>Uploads Within Website</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.orm.impl.SingletonFileImpl#getRelativeUploadDirectory <em>Relative Upload Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SingletonFileImpl extends SingletonAttributeImpl implements SingletonFile {
	/**
	...
	protected EClass eStaticClass() {
		return OrmPackage.Literals.SINGLETON_FILE;
	}
	...
	public void setMaximumUploadSize(int newMaximumUploadSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.SINGLETON_FILE__MAXIMUM_UPLOAD_SIZE, oldMaximumUploadSize, maximumUploadSize));
	}
	...
	public EList<String> getValidUploadMimeTypes() {
		if (validUploadMimeTypes == null) {
			validUploadMimeTypes = new EDataTypeUniqueEList<String>(String.class, this, OrmPackage.SINGLETON_FILE__VALID_UPLOAD_MIME_TYPES);
		}
	...
	public EList<String> getValidUploadExtensions() {
		if (validUploadExtensions == null) {
			validUploadExtensions = new EDataTypeUniqueEList<String>(String.class, this, OrmPackage.SINGLETON_FILE__VALID_UPLOAD_EXTENSIONS);
		}
	...
	public void setUploadsWithinWebsite(boolean newUploadsWithinWebsite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.SINGLETON_FILE__UPLOADS_WITHIN_WEBSITE, oldUploadsWithinWebsite, uploadsWithinWebsite));
	}
	...
	public void setRelativeUploadDirectory(String newRelativeUploadDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.SINGLETON_FILE__RELATIVE_UPLOAD_DIRECTORY, oldRelativeUploadDirectory, relativeUploadDirectory));
	}
