...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UnitElement4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UnitElement4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName4EditPart) {
			((UnitElementName4EditPart) childEditPart)
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == WebsiteElementTypes.SelectAction_3102) {
				return getChildBySemanticHint(WebsiteVisualIDRegistry
