...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement15ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UnitElement15EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement15EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UnitElement15ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName15EditPart) {
			((UnitElementName15EditPart) childEditPart)
