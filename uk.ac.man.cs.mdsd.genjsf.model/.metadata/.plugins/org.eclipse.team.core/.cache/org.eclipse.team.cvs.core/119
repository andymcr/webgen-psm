...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitSupportAction2EditPart;
 ...
 * @generated
 */
public class DetailsUnitItemSemanticEditPolicy extends
		WebsiteBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public DetailsUnitItemSemanticEditPolicy() {
