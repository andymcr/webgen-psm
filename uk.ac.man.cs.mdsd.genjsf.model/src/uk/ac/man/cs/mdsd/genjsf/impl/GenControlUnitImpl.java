...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gen Control Unit</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.genjsf.impl.GenControlUnitImpl#getMessagePlacementOption <em>Message Placement Option</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.genjsf.impl.GenControlUnitImpl#getGenCancelDestination <em>Gen Cancel Destination</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class GenControlUnitImpl extends GenDynamicUnitImpl implements GenControlUnit {
	/**
	...
	protected EClass eStaticClass() {
		return GenJsfPackage.Literals.GEN_CONTROL_UNIT;
	}
	...
	public void setMessagePlacementOption(InputMessagePlacementOptions newMessagePlacementOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenJsfPackage.GEN_CONTROL_UNIT__MESSAGE_PLACEMENT_OPTION, oldMessagePlacementOption, messagePlacementOption));
	}
	...
	public GenPage getGenCancelDestination() {
		if (genCancelDestination != null && genCancelDestination.eIsProxy()) {
			...
			if (genCancelDestination != oldGenCancelDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GenJsfPackage.GEN_CONTROL_UNIT__GEN_CANCEL_DESTINATION, oldGenCancelDestination, genCancelDestination));
			}
		}
	...
	public void setGenCancelDestination(GenPage newGenCancelDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenJsfPackage.GEN_CONTROL_UNIT__GEN_CANCEL_DESTINATION, oldGenCancelDestination, genCancelDestination));
	}
	...
	protected void reconcileSettings(final GenContentUnit oldGenUnit) {
		...
		if (oldGenUnit instanceof GenControlUnit) {
			final GenControlUnit oldGenControlUnit = (GenControlUnit) oldGenUnit;
			setMessagePlacementOption(oldGenControlUnit.getMessagePlacementOption());
		}
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenJsfPackage.GEN_CONTROL_UNIT__MESSAGE_PLACEMENT_OPTION:
				return getMessagePlacementOption();
			case GenJsfPackage.GEN_CONTROL_UNIT__GEN_CANCEL_DESTINATION:
