...
import work.andycarpenter.psms.service.FeatureReference;
import work.andycarpenter.psms.service.ServicePackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.psms.service.FeatureReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureReferenceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.FEATURE_REFERENCE__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FeatureReference.class)) {
			case ServicePackage.FEATURE_REFERENCE__SUFFIXES:
