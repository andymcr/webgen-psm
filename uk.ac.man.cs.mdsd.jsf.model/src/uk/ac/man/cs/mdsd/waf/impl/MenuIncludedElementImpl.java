 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.MenuIncludedElementImpl#getName <em>Name</em>}</li>
...
public class MenuIncludedElementImpl extends MenuIncludedFeatureImpl implements MenuIncludedElement {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WafPackage.Literals.MENU_INCLUDED_ELEMENT__NAME).getSettingDelegate();
	/**
