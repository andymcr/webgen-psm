 ...
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.FixedPageMenuEntryImpl#getDestination <em>Destination</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FixedPageMenuEntryImpl extends MenuEntryImpl implements FixedPageMenuEntry {
	...
	public Page getDestination() {
		if (destination != null && destination.eIsProxy()) {
			...
			if (destination != oldDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WafPackage.FIXED_PAGE_MENU_ENTRY__DESTINATION, oldDestination, destination));
			}
		}
		return destination;
	}
	...
	public void setDestination(Page newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.FIXED_PAGE_MENU_ENTRY__DESTINATION, oldDestination, destination));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WafPackage.FIXED_PAGE_MENU_ENTRY__DESTINATION:
