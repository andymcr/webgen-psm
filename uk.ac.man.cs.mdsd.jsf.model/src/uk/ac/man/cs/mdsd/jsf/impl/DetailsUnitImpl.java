 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DetailsUnitImpl#getTargettingActions <em>Targetting Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DetailsUnitImpl#isOmitFieldLabels <em>Omit Field Labels</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DetailsUnitImpl extends DataUnitImpl implements DetailsUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.DETAILS_UNIT;
	}
	...
	public EList<SelectAction> getTargettingActions() {
		if (targettingActions == null) {
			targettingActions = new EObjectWithInverseResolvingEList<SelectAction>(SelectAction.class, this, JsfPackage.DETAILS_UNIT__TARGETTING_ACTIONS, JsfPackage.SELECT_ACTION__TARGET);
		}
	...
	public void setOmitFieldLabels(boolean newOmitFieldLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.DETAILS_UNIT__OMIT_FIELD_LABELS, oldOmitFieldLabels, omitFieldLabels));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.DETAILS_UNIT__TARGETTING_ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JsfPackage.DETAILS_UNIT__OMIT_FIELD_LABELS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectTarget.class) {
			switch (derivedFeatureID) {
				case JsfPackage.DETAILS_UNIT__TARGETTING_ACTIONS: return JsfPackage.SELECT_TARGET__TARGETTING_ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectTarget.class) {
			switch (baseFeatureID) {
				case JsfPackage.SELECT_TARGET__TARGETTING_ACTIONS: return JsfPackage.DETAILS_UNIT__TARGETTING_ACTIONS;
				default: return -1;
			}
		}
