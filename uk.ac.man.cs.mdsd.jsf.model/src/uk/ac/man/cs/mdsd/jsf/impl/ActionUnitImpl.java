 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ActionUnitImpl#isOmitFieldLabels <em>Omit Field Labels</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionUnitImpl extends ControlUnitImpl implements ActionUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.ACTION_UNIT;
	}
	...
	public void setOmitFieldLabels(boolean newOmitFieldLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.ACTION_UNIT__OMIT_FIELD_LABELS, oldOmitFieldLabels, omitFieldLabels));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.ACTION_UNIT__OMIT_FIELD_LABELS:
