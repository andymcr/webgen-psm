 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.MenuEntry#getPartOf <em>Part Of</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getMenuEntry()
 * @model abstract="true"
 * @generated
 */
public interface MenuEntry extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link uk.ac.man.cs.mdsd.jsf.Menu#getEntries <em>Entries</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setPartOf(Menu)
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getMenuEntry_PartOf()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.MenuEntry#getPartOf <em>Part Of</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
