 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getForcedValue <em>Forced Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getDisplayClass <em>Display Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getDisplayedOn <em>Displayed On</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getDateFormat <em>Date Format</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getActions <em>Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#isOnlyDisplayWhenNotEmpty <em>Only Display When Not Empty</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getDisplayOption <em>Display Option</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getLinkedAction <em>Linked Action</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#getMaximumDisplaySize <em>Maximum Display Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitFeatureImpl#isAutofocus <em>Autofocus</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UnitFeatureImpl extends NamedElementImpl implements UnitFeature {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.UNIT_FEATURE;
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public NotificationChain basicSetForcedValue(Expression newForcedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__FORCED_VALUE, oldForcedValue, newForcedValue);
	...
	public void setForcedValue(Expression newForcedValue) {
		if (newForcedValue != forcedValue) {
			...
			if (forcedValue != null)
				msgs = ((InternalEObject)forcedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsfPackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			if (newForcedValue != null)
				msgs = ((InternalEObject)newForcedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsfPackage.UNIT_FEATURE__FORCED_VALUE, null, msgs);
			msgs = basicSetForcedValue(newForcedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__FORCED_VALUE, newForcedValue, newForcedValue));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__FOOTER, oldFooter, footer));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setDisplayClass(String newDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__DISPLAY_CLASS, oldDisplayClass, displayClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public DynamicUnit getDisplayedOn() {
		if (eContainerFeatureID() != JsfPackage.UNIT_FEATURE__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(DynamicUnit newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, JsfPackage.UNIT_FEATURE__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(DynamicUnit newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != JsfPackage.UNIT_FEATURE__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setCardinality(Cardinality newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public EList<InlineAction> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentWithInverseEList<InlineAction>(InlineAction.class, this, JsfPackage.UNIT_FEATURE__ACTIONS, JsfPackage.INLINE_ACTION__USED_BY);
		}
		return actions;
	}
	...
	public void setOnlyDisplayWhenNotEmpty(boolean newOnlyDisplayWhenNotEmpty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__ONLY_DISPLAY_WHEN_NOT_EMPTY, oldOnlyDisplayWhenNotEmpty, onlyDisplayWhenNotEmpty));
	}
	...
	public void setDisplayOption(CollectionDisplayOptions newDisplayOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__DISPLAY_OPTION, oldDisplayOption, displayOption));
	}
	...
	public SelectAction getLinkedAction() {
		if (linkedAction != null && linkedAction.eIsProxy()) {
			...
			if (linkedAction != oldLinkedAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.UNIT_FEATURE__LINKED_ACTION, oldLinkedAction, linkedAction));
			}
		}
		return linkedAction;
	}
	...
	public void setLinkedAction(SelectAction newLinkedAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__LINKED_ACTION, oldLinkedAction, linkedAction));
	}
	...
	public void setMaximumDisplaySize(int newMaximumDisplaySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__MAXIMUM_DISPLAY_SIZE, oldMaximumDisplaySize, maximumDisplaySize));
	}
	...
	public void setAutofocus(boolean newAutofocus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_FEATURE__AUTOFOCUS, oldAutofocus, autofocus));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.UNIT_FEATURE__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JsfPackage.UNIT_FEATURE__LINKED_ACTION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IncludedFeature.class) {
			switch (derivedFeatureID) {
				case JsfPackage.UNIT_FEATURE__DISPLAY_LABEL: return JsfPackage.INCLUDED_FEATURE__DISPLAY_LABEL;
				case JsfPackage.UNIT_FEATURE__FORCED_VALUE: return JsfPackage.INCLUDED_FEATURE__FORCED_VALUE;
				case JsfPackage.UNIT_FEATURE__FOOTER: return JsfPackage.INCLUDED_FEATURE__FOOTER;
				case JsfPackage.UNIT_FEATURE__HEADER_CLASS: return JsfPackage.INCLUDED_FEATURE__HEADER_CLASS;
				case JsfPackage.UNIT_FEATURE__INPUT_CLASS: return JsfPackage.INCLUDED_FEATURE__INPUT_CLASS;
				case JsfPackage.UNIT_FEATURE__DISPLAY_CLASS: return JsfPackage.INCLUDED_FEATURE__DISPLAY_CLASS;
				case JsfPackage.UNIT_FEATURE__FOOTER_CLASS: return JsfPackage.INCLUDED_FEATURE__FOOTER_CLASS;
				default: return -1;
			}
		}
		if (baseClass == UnitField.class) {
			switch (derivedFeatureID) {
				case JsfPackage.UNIT_FEATURE__DISPLAYED_ON: return JsfPackage.UNIT_FIELD__DISPLAYED_ON;
				case JsfPackage.UNIT_FEATURE__CARDINALITY: return JsfPackage.UNIT_FIELD__CARDINALITY;
				case JsfPackage.UNIT_FEATURE__DATE_FORMAT: return JsfPackage.UNIT_FIELD__DATE_FORMAT;
				default: return -1;
			}
		}
		if (baseClass == InlineActionContainer.class) {
			switch (derivedFeatureID) {
				case JsfPackage.UNIT_FEATURE__ACTIONS: return JsfPackage.INLINE_ACTION_CONTAINER__ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IncludedFeature.class) {
			switch (baseFeatureID) {
				case JsfPackage.INCLUDED_FEATURE__DISPLAY_LABEL: return JsfPackage.UNIT_FEATURE__DISPLAY_LABEL;
				case JsfPackage.INCLUDED_FEATURE__FORCED_VALUE: return JsfPackage.UNIT_FEATURE__FORCED_VALUE;
				case JsfPackage.INCLUDED_FEATURE__FOOTER: return JsfPackage.UNIT_FEATURE__FOOTER;
				case JsfPackage.INCLUDED_FEATURE__HEADER_CLASS: return JsfPackage.UNIT_FEATURE__HEADER_CLASS;
				case JsfPackage.INCLUDED_FEATURE__INPUT_CLASS: return JsfPackage.UNIT_FEATURE__INPUT_CLASS;
				case JsfPackage.INCLUDED_FEATURE__DISPLAY_CLASS: return JsfPackage.UNIT_FEATURE__DISPLAY_CLASS;
				case JsfPackage.INCLUDED_FEATURE__FOOTER_CLASS: return JsfPackage.UNIT_FEATURE__FOOTER_CLASS;
				default: return -1;
			}
		}
		if (baseClass == UnitField.class) {
			switch (baseFeatureID) {
				case JsfPackage.UNIT_FIELD__DISPLAYED_ON: return JsfPackage.UNIT_FEATURE__DISPLAYED_ON;
				case JsfPackage.UNIT_FIELD__CARDINALITY: return JsfPackage.UNIT_FEATURE__CARDINALITY;
				case JsfPackage.UNIT_FIELD__DATE_FORMAT: return JsfPackage.UNIT_FEATURE__DATE_FORMAT;
				default: return -1;
			}
		}
		if (baseClass == InlineActionContainer.class) {
			switch (baseFeatureID) {
				case JsfPackage.INLINE_ACTION_CONTAINER__ACTIONS: return JsfPackage.UNIT_FEATURE__ACTIONS;
				default: return -1;
			}
		}
