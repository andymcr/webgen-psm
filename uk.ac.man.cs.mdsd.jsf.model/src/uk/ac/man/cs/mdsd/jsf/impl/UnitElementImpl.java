 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitElementImpl#isObfuscateFormFields <em>Obfuscate Form Fields</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitElementImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitElementImpl#getServiceFeature <em>Service Feature</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitElementImpl#getPlaceholder <em>Placeholder</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitElementImpl#getValidationPattern <em>Validation Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitElementImpl extends UnitFeatureImpl implements UnitElement {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.UNIT_ELEMENT;
	}
	...
	public void setObfuscateFormFields(boolean newObfuscateFormFields) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__OBFUSCATE_FORM_FIELDS, oldObfuscateFormFields, obfuscateFormFields));
	}
	...
	public NotificationChain basicSetDefaultValue(Expression newDefaultValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(Expression newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
	...
	public ServiceEntityElement getServiceFeature() {
		if (serviceFeature != null && serviceFeature.eIsProxy()) {
			...
			if (serviceFeature != oldServiceFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.UNIT_ELEMENT__SERVICE_FEATURE, oldServiceFeature, serviceFeature));
			}
		}
	...
	public void setServiceFeature(ServiceEntityElement newServiceFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__SERVICE_FEATURE, oldServiceFeature, serviceFeature));
	}
	...
	public void setPlaceholder(String newPlaceholder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__PLACEHOLDER, oldPlaceholder, placeholder));
	}
	...
	public void setValidationPattern(String newValidationPattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_ELEMENT__VALIDATION_PATTERN, oldValidationPattern, validationPattern));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.UNIT_ELEMENT__OBFUSCATE_FORM_FIELDS:
				return isObfuscateFormFields();
			case JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE:
				return getDefaultValue();
			case JsfPackage.UNIT_ELEMENT__SERVICE_FEATURE:
				if (resolve) return getServiceFeature();
				return basicGetServiceFeature();
			case JsfPackage.UNIT_ELEMENT__PLACEHOLDER:
				return getPlaceholder();
			case JsfPackage.UNIT_ELEMENT__VALIDATION_PATTERN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IncludedElement.class) {
			switch (derivedFeatureID) {
				case JsfPackage.UNIT_ELEMENT__OBFUSCATE_FORM_FIELDS: return JsfPackage.INCLUDED_ELEMENT__OBFUSCATE_FORM_FIELDS;
				case JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE: return JsfPackage.INCLUDED_ELEMENT__DEFAULT_VALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IncludedElement.class) {
			switch (baseFeatureID) {
				case JsfPackage.INCLUDED_ELEMENT__OBFUSCATE_FORM_FIELDS: return JsfPackage.UNIT_ELEMENT__OBFUSCATE_FORM_FIELDS;
				case JsfPackage.INCLUDED_ELEMENT__DEFAULT_VALUE: return JsfPackage.UNIT_ELEMENT__DEFAULT_VALUE;
				default: return -1;
			}
		}
