 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.MenuImpl#getEntries <em>Entries</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.MenuImpl#isOmitCaption <em>Omit Caption</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.MenuImpl#getCaptionClass <em>Caption Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.MenuImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.MenuImpl#getLayoutClass <em>Layout Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MenuImpl extends NamedDisplayElementImpl implements Menu {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.MENU;
	}
	...
	public EList<MenuEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<MenuEntry>(MenuEntry.class, this, JsfPackage.MENU__ENTRIES, JsfPackage.MENU_ENTRY__PART_OF);
		}
		return entries;
	}
	...
	public void setOmitCaption(boolean newOmitCaption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.MENU__OMIT_CAPTION, oldOmitCaption, omitCaption));
	}
	...
	public void setCaptionClass(String newCaptionClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.MENU__CAPTION_CLASS, oldCaptionClass, captionClass));
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.MENU__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setLayoutClass(String newLayoutClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.MENU__LAYOUT_CLASS, oldLayoutClass, layoutClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.MENU__ENTRIES:
				return getEntries();
			case JsfPackage.MENU__OMIT_CAPTION:
				return isOmitCaption();
			case JsfPackage.MENU__CAPTION_CLASS:
				return getCaptionClass();
			case JsfPackage.MENU__STYLE_CLASS:
				return getStyleClass();
			case JsfPackage.MENU__LAYOUT_CLASS:
