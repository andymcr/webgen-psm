 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.SearchUnitImpl#getResultsDestination <em>Results Destination</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SearchUnitImpl extends ControlUnitImpl implements SearchUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.SEARCH_UNIT;
	}
		...
		if (resultsDestination != null && resultsDestination.eIsProxy()) {
			...
			if (resultsDestination != oldResultsDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.SEARCH_UNIT__RESULTS_DESTINATION, oldResultsDestination, resultsDestination));
			}
		}
	...
	public NotificationChain basicSetResultsDestination(IndexUnit newResultsDestination, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsfPackage.SEARCH_UNIT__RESULTS_DESTINATION, oldResultsDestination, newResultsDestination);
	...
	public void setResultsDestination(IndexUnit newResultsDestination) {
		if (newResultsDestination != resultsDestination) {
			...
			if (resultsDestination != null)
				msgs = ((InternalEObject)resultsDestination).eInverseRemove(this, JsfPackage.INDEX_UNIT__TARGETTING_SEARCHES, IndexUnit.class, msgs);
			if (newResultsDestination != null)
				msgs = ((InternalEObject)newResultsDestination).eInverseAdd(this, JsfPackage.INDEX_UNIT__TARGETTING_SEARCHES, IndexUnit.class, msgs);
			msgs = basicSetResultsDestination(newResultsDestination, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.SEARCH_UNIT__RESULTS_DESTINATION, newResultsDestination, newResultsDestination));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.SEARCH_UNIT__RESULTS_DESTINATION:
				if (resultsDestination != null)
					msgs = ((InternalEObject)resultsDestination).eInverseRemove(this, JsfPackage.INDEX_UNIT__TARGETTING_SEARCHES, IndexUnit.class, msgs);
