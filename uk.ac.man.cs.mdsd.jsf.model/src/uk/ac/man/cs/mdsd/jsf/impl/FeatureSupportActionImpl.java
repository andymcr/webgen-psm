 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.FeatureSupportActionImpl#getConfirmMessage <em>Confirm Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureSupportActionImpl extends InlineActionImpl implements FeatureSupportAction {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.FEATURE_SUPPORT_ACTION;
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.FEATURE_SUPPORT_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.FEATURE_SUPPORT_ACTION__CONFIRM_MESSAGE:
