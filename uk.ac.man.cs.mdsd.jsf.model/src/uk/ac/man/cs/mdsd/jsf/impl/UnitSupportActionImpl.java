 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.UnitSupportActionImpl#getConfirmMessage <em>Confirm Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitSupportActionImpl extends NamedDisplayElementImpl implements UnitSupportAction {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.UNIT_SUPPORT_ACTION;
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.UNIT_SUPPORT_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.UNIT_SUPPORT_ACTION__CONFIRM_MESSAGE:
