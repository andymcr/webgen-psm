 ...
 * </copyright>
 *
 * $Id: JsfSwitch.java,v 1.63 2014/08/22 14:32:57 andy Exp $
 */
 ...
 * @generated
 */
public class JsfSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JsfPackage.JSF_MODEL: {
				JsfModel jsfModel = (JsfModel)theEObject;
				T result = caseJsfModel(jsfModel);
			...
			case JsfPackage.LOCAL_AUTHENTICATION_SYSTEM: {
			...
			case JsfPackage.CAS_AUTHENTICATION: {
			...
			case JsfPackage.INCLUDED_ASSOCIATION: {
			...
			case JsfPackage.SERVICE_ENTITY_ELEMENT: {
			...
			case JsfPackage.SERVICE_ASSOCIATION: {
			...
			case JsfPackage.SERVICE_ENTITY_ASSOCIATION: {
			...
			case JsfPackage.SERVICE_VIEW_ASSOCIATION: {
			...
			case JsfPackage.FIXED_PAGE_MENU_ENTRY: {
			...
			case JsfPackage.FIXED_ACTION_MENU_ENTRY: {
			...
			case JsfPackage.FIXED_COMMAND_MENU_ENTRY: {
			...
			case JsfPackage.EDIT_STATIC_TEXT_MENU_ENTRY: {
			...
			case JsfPackage.MENU_INCLUDED_FEATURE: {
			...
			case JsfPackage.MENU_INCLUDED_ELEMENT: {
			...
			case JsfPackage.CREATE_SITEMAP_UNIT: {
			...
			case JsfPackage.UNIT_ASSOCIATION: {
			...
			case JsfPackage.UNIT_CHILD_ASSOCIATION: {
			...
			case JsfPackage.INTERFACE_FIELD: {
			...
			case JsfPackage.DATA_TYPE_FIELD: {
			...
			case JsfPackage.UNIT_SUPPORT_ACTION: {
			...
			case JsfPackage.CREATE_UPDATE_UNIT: {
			...
			case JsfPackage.INDEX_GRID_UNIT: {
			...
			case JsfPackage.INDEX_PAGE_DIRECTION_UNIT: {
			...
			case JsfPackage.INDEX_LINE_DIRECTION_UNIT: {
			...
			case JsfPackage.FORGOTTEN_PASSWORD_UNIT: {
			...
			case JsfPackage.INLINE_ACTION_CONTAINER: {
			...
			case JsfPackage.FEATURE_SUPPORT_ACTION: {
			...
			case JsfPackage.MODEL_REFERENCE: {
			...
			case JsfPackage.FEATURE_REFERENCE: {
			...
			case JsfPackage.CURRENT_USER_REFERENCE: {
