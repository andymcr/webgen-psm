 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ControlUnitImpl#getSubmitLabel <em>Submit Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ControlUnitImpl#getCancelDestination <em>Cancel Destination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ControlUnitImpl#getCancelLabel <em>Cancel Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ControlUnitImpl extends DynamicUnitImpl implements ControlUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.CONTROL_UNIT;
	}
	...
	public void setSubmitLabel(String newSubmitLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.CONTROL_UNIT__SUBMIT_LABEL, oldSubmitLabel, submitLabel));
	}
	...
	public Page getCancelDestination() {
		if (cancelDestination != null && cancelDestination.eIsProxy()) {
			...
			if (cancelDestination != oldCancelDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.CONTROL_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
			}
		}
	...
	public void setCancelDestination(Page newCancelDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.CONTROL_UNIT__CANCEL_DESTINATION, oldCancelDestination, cancelDestination));
	}
	...
	public void setCancelLabel(String newCancelLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.CONTROL_UNIT__CANCEL_LABEL, oldCancelLabel, cancelLabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.CONTROL_UNIT__SUBMIT_LABEL:
				return getSubmitLabel();
			case JsfPackage.CONTROL_UNIT__CANCEL_DESTINATION:
				if (resolve) return getCancelDestination();
				return basicGetCancelDestination();
			case JsfPackage.CONTROL_UNIT__CANCEL_LABEL:
