 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.LoginUnitImpl#getAuthenticationSystem <em>Authentication System</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.LoginUnitImpl#getLoginIdField <em>Login Id Field</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.LoginUnitImpl#getPasswordField <em>Password Field</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.LoginUnitImpl#getRememberMeField <em>Remember Me Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoginUnitImpl extends ControlUnitImpl implements LoginUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.LOGIN_UNIT;
	}
		...
		if (authenticationSystem != null && authenticationSystem.eIsProxy()) {
			...
			if (authenticationSystem != oldAuthenticationSystem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.LOGIN_UNIT__AUTHENTICATION_SYSTEM, oldAuthenticationSystem, authenticationSystem));
			}
		}
	...
	public NotificationChain basicSetAuthenticationSystem(LocalAuthenticationSystem newAuthenticationSystem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsfPackage.LOGIN_UNIT__AUTHENTICATION_SYSTEM, oldAuthenticationSystem, newAuthenticationSystem);
	...
	public void setAuthenticationSystem(LocalAuthenticationSystem newAuthenticationSystem) {
		if (newAuthenticationSystem != authenticationSystem) {
			...
			if (authenticationSystem != null)
				msgs = ((InternalEObject)authenticationSystem).eInverseRemove(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__LOGIN_UNIT, LocalAuthenticationSystem.class, msgs);
			if (newAuthenticationSystem != null)
				msgs = ((InternalEObject)newAuthenticationSystem).eInverseAdd(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__LOGIN_UNIT, LocalAuthenticationSystem.class, msgs);
			msgs = basicSetAuthenticationSystem(newAuthenticationSystem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.LOGIN_UNIT__AUTHENTICATION_SYSTEM, newAuthenticationSystem, newAuthenticationSystem));
	}
	...
	public UnitField getLoginIdField() {
		if (loginIdField != null && loginIdField.eIsProxy()) {
			...
			if (loginIdField != oldLoginIdField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.LOGIN_UNIT__LOGIN_ID_FIELD, oldLoginIdField, loginIdField));
			}
		}
		return loginIdField;
	}
	...
	public void setLoginIdField(UnitField newLoginIdField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.LOGIN_UNIT__LOGIN_ID_FIELD, oldLoginIdField, loginIdField));
	}
	...
	public UnitField getPasswordField() {
		if (passwordField != null && passwordField.eIsProxy()) {
			...
			if (passwordField != oldPasswordField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.LOGIN_UNIT__PASSWORD_FIELD, oldPasswordField, passwordField));
			}
		}
	...
	public void setPasswordField(UnitField newPasswordField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.LOGIN_UNIT__PASSWORD_FIELD, oldPasswordField, passwordField));
	}
	...
	public UnitField getRememberMeField() {
		if (rememberMeField != null && rememberMeField.eIsProxy()) {
			...
			if (rememberMeField != oldRememberMeField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.LOGIN_UNIT__REMEMBER_ME_FIELD, oldRememberMeField, rememberMeField));
			}
		}
	...
	public void setRememberMeField(UnitField newRememberMeField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.LOGIN_UNIT__REMEMBER_ME_FIELD, oldRememberMeField, rememberMeField));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.LOGIN_UNIT__AUTHENTICATION_SYSTEM:
				if (authenticationSystem != null)
					msgs = ((InternalEObject)authenticationSystem).eInverseRemove(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__LOGIN_UNIT, LocalAuthenticationSystem.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JsfPackage.LOGIN_UNIT__LOGIN_ID_FIELD:
				if (resolve) return getLoginIdField();
				return basicGetLoginIdField();
			case JsfPackage.LOGIN_UNIT__PASSWORD_FIELD:
				if (resolve) return getPasswordField();
				return basicGetPasswordField();
			case JsfPackage.LOGIN_UNIT__REMEMBER_ME_FIELD:
