 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.CreateUpdateUnitImpl#getTargettingActions <em>Targetting Actions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.CreateUpdateUnitImpl#getClearLabel <em>Clear Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreateUpdateUnitImpl extends EditUnitImpl implements CreateUpdateUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.CREATE_UPDATE_UNIT;
	}
	...
	public EList<SelectAction> getTargettingActions() {
		if (targettingActions == null) {
			targettingActions = new EObjectWithInverseResolvingEList<SelectAction>(SelectAction.class, this, JsfPackage.CREATE_UPDATE_UNIT__TARGETTING_ACTIONS, JsfPackage.SELECT_ACTION__TARGET);
		}
	...
	public void setClearLabel(String newClearLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.CREATE_UPDATE_UNIT__CLEAR_LABEL, oldClearLabel, clearLabel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.CREATE_UPDATE_UNIT__TARGETTING_ACTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JsfPackage.CREATE_UPDATE_UNIT__CLEAR_LABEL:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SelectTarget.class) {
			switch (derivedFeatureID) {
				case JsfPackage.CREATE_UPDATE_UNIT__TARGETTING_ACTIONS: return JsfPackage.SELECT_TARGET__TARGETTING_ACTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SelectTarget.class) {
			switch (baseFeatureID) {
				case JsfPackage.SELECT_TARGET__TARGETTING_ACTIONS: return JsfPackage.CREATE_UPDATE_UNIT__TARGETTING_ACTIONS;
				default: return -1;
			}
		}
