 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.CommandUnitImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandUnitImpl extends ContentUnitImpl implements CommandUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.COMMAND_UNIT;
	}
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentWithInverseEList<Command>(Command.class, this, JsfPackage.COMMAND_UNIT__COMMANDS, JsfPackage.COMMAND__PART_OF);
		}
		return commands;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.COMMAND_UNIT__COMMANDS:
