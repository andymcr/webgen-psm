 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ForgottenPasswordUnitImpl#getAuthenticationSystem <em>Authentication System</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.ForgottenPasswordUnitImpl#getLoginIdField <em>Login Id Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForgottenPasswordUnitImpl extends ControlUnitImpl implements ForgottenPasswordUnit {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.FORGOTTEN_PASSWORD_UNIT;
	}
		...
		if (authenticationSystem != null && authenticationSystem.eIsProxy()) {
			...
			if (authenticationSystem != oldAuthenticationSystem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.FORGOTTEN_PASSWORD_UNIT__AUTHENTICATION_SYSTEM, oldAuthenticationSystem, authenticationSystem));
			}
		}
	...
	public NotificationChain basicSetAuthenticationSystem(LocalAuthenticationSystem newAuthenticationSystem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JsfPackage.FORGOTTEN_PASSWORD_UNIT__AUTHENTICATION_SYSTEM, oldAuthenticationSystem, newAuthenticationSystem);
	...
	public void setAuthenticationSystem(LocalAuthenticationSystem newAuthenticationSystem) {
		if (newAuthenticationSystem != authenticationSystem) {
			...
			if (authenticationSystem != null)
				msgs = ((InternalEObject)authenticationSystem).eInverseRemove(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__FORGOTTEN_PASSWORD_UNIT, LocalAuthenticationSystem.class, msgs);
			if (newAuthenticationSystem != null)
				msgs = ((InternalEObject)newAuthenticationSystem).eInverseAdd(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__FORGOTTEN_PASSWORD_UNIT, LocalAuthenticationSystem.class, msgs);
			msgs = basicSetAuthenticationSystem(newAuthenticationSystem, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.FORGOTTEN_PASSWORD_UNIT__AUTHENTICATION_SYSTEM, newAuthenticationSystem, newAuthenticationSystem));
	}
	...
	public UnitField getLoginIdField() {
		if (loginIdField != null && loginIdField.eIsProxy()) {
			...
			if (loginIdField != oldLoginIdField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.FORGOTTEN_PASSWORD_UNIT__LOGIN_ID_FIELD, oldLoginIdField, loginIdField));
			}
		}
		return loginIdField;
	}
	...
	public void setLoginIdField(UnitField newLoginIdField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.FORGOTTEN_PASSWORD_UNIT__LOGIN_ID_FIELD, oldLoginIdField, loginIdField));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JsfPackage.FORGOTTEN_PASSWORD_UNIT__AUTHENTICATION_SYSTEM:
				if (authenticationSystem != null)
					msgs = ((InternalEObject)authenticationSystem).eInverseRemove(this, JsfPackage.LOCAL_AUTHENTICATION_SYSTEM__FORGOTTEN_PASSWORD_UNIT, LocalAuthenticationSystem.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JsfPackage.FORGOTTEN_PASSWORD_UNIT__LOGIN_ID_FIELD:
