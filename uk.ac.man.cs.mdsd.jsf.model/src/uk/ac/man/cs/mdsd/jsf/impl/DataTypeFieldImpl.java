 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DataTypeFieldImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DataTypeFieldImpl#isCaseInsensitive <em>Case Insensitive</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DataTypeFieldImpl#isObfuscateFormFields <em>Obfuscate Form Fields</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.impl.DataTypeFieldImpl#isEncrypt <em>Encrypt</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeFieldImpl extends InterfaceFieldImpl implements DataTypeField {
	...
	protected EClass eStaticClass() {
		return JsfPackage.Literals.DATA_TYPE_FIELD;
	}
		...
		if (dataType != null && dataType.eIsProxy()) {
			...
			if (dataType != oldDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, JsfPackage.DATA_TYPE_FIELD__DATA_TYPE, oldDataType, dataType));
			}
		}
		return dataType;
	}
	...
	public void setDataType(DataType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.DATA_TYPE_FIELD__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setCaseInsensitive(boolean newCaseInsensitive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.DATA_TYPE_FIELD__CASE_INSENSITIVE, oldCaseInsensitive, caseInsensitive));
	}
	...
	public void setObfuscateFormFields(boolean newObfuscateFormFields) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.DATA_TYPE_FIELD__OBFUSCATE_FORM_FIELDS, oldObfuscateFormFields, obfuscateFormFields));
	}
	...
	public void setEncrypt(boolean newEncrypt) {
		...
		encrypt = newEncrypt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JsfPackage.DATA_TYPE_FIELD__ENCRYPT, oldEncrypt, encrypt));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JsfPackage.DATA_TYPE_FIELD__DATA_TYPE:
