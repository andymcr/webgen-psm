 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#isOmitColumnLabels <em>Omit Column Labels</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getDefaultPaginationSize <em>Default Pagination Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getNextPageLabel <em>Next Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getPreviousPageLabel <em>Previous Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getFirstPageLabel <em>First Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getLastPageLabel <em>Last Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getTargettingSearches <em>Targetting Searches</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getRowClasses <em>Row Classes</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit()
 * @model abstract="true"
 * @generated
 */
public interface IndexUnit extends DataUnit, InlineActionContainer, SelectTarget {
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_OmitColumnLabels()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#isOmitColumnLabels <em>Omit Column Labels</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_DefaultPaginationSize()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getDefaultPaginationSize <em>Default Pagination Size</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_NextPageLabel()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getNextPageLabel <em>Next Page Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_PreviousPageLabel()
	 * @model default="" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getPreviousPageLabel <em>Previous Page Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_UseFirstLastPageLinks()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_FirstPageLabel()
	 * @model default="" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getFirstPageLabel <em>First Page Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_LastPageLabel()
	 * @model default="" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getLastPageLabel <em>Last Page Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link uk.ac.man.cs.mdsd.jsf.SearchUnit#getResultsDestination <em>Results Destination</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_TargettingSearches()
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getTargettingSearches <em>Targetting Searches</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getIndexUnit_RowClasses()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.IndexUnit#getRowClasses <em>Row Classes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
