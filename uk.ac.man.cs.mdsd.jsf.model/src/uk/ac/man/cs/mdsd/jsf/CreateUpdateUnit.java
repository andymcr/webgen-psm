 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.jsf.CreateUpdateUnit#getClearLabel <em>Clear Label</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getCreateUpdateUnit()
 * @model
 * @generated
 */
public interface CreateUpdateUnit extends EditUnit, SelectTarget {
	 ...
	 * @see uk.ac.man.cs.mdsd.jsf.JsfPackage#getCreateUpdateUnit_ClearLabel()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.jsf.CreateUpdateUnit#getClearLabel <em>Clear Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
