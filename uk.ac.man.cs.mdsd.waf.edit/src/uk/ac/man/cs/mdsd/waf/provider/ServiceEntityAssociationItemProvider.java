...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.waf.ServiceEntityAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceEntityAssociationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WafPackage.Literals.SERVICE_ENTITY_ASSOCIATION__FEATURE,
				 true,
				 false,
				 true,
				 null,
  ...
  {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ServiceEntityAssociation"));
	}
