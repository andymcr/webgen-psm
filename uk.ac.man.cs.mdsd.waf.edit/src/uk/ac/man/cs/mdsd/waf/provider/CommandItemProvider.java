...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.waf.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Command_partOf_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Command_partOf_feature", "_UI_Command_type"),
         WafPackage.Literals.COMMAND__PART_OF,
         true,
         false,
         true,
         null,
