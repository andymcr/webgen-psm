...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.waf.QueryInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryInstanceItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WafPackage.Literals.QUERY_INSTANCE__QUERY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WafPackage.Literals.QUERY_INSTANCE__ACTUALS);
		}
	...
	public String getText(Object object) {
		String label = ((QueryInstance)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QueryInstance_type") :
			getString("_UI_QueryInstance_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WafPackage.Literals.QUERY_INSTANCE__ACTUALS,
				 WafFactory.eINSTANCE.createQueryActual()));
	}
