...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.waf.KeyActual} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeyActualItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KeyActual_container_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KeyActual_container_feature", "_UI_KeyActual_type"),
				 WafPackage.Literals.KEY_ACTUAL__CONTAINER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WafPackage.Literals.KEY_ACTUAL__KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WafPackage.Literals.KEY_ACTUAL__ACTUAL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WafPackage.Literals.KEY_ACTUAL__ACTUAL,
