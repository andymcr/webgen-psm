...
import work.andycarpenter.metamodel.base.BaseModel;
import work.andycarpenter.metamodel.base.BasePackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.base.BaseModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BasePackage.Literals.BASE_MODEL__LITERALS);
			childrenFeatures.add(BasePackage.Literals.BASE_MODEL__DATA_TYPES);
		}
	...
	public String getText(Object object) {
		return getString("_UI_BaseModel_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BaseModel.class)) {
			case BasePackage.BASE_MODEL__LITERALS:
			case BasePackage.BASE_MODEL__DATA_TYPES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BasePackage.Literals.BASE_MODEL__LITERALS,
		...
		newChildDescriptors.add
			(createChildParameter
				(BasePackage.Literals.BASE_MODEL__DATA_TYPES,
