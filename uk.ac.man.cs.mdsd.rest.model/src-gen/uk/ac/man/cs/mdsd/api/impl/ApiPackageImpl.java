...
public class ApiPackageImpl extends EPackageImpl implements ApiPackage {
	 ...
	 * @generated
	 */
	private EClass resourceSelectionEClass = null;
	...
	public EReference getResourceSelection_Selection() {
		return (EReference)resourceSelectionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getResourceSelection_Name() {
		return (EAttribute)resourceSelectionEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(resourceEClass, RESOURCE__GET_ALL);
		createEReference(resourceEClass, RESOURCE__GET_ONE);
		...
		resourceSelectionEClass = createEClass(RESOURCE_SELECTION);
		createEReference(resourceSelectionEClass, RESOURCE_SELECTION__PARENT_RESOURCE);
		createEReference(resourceSelectionEClass, RESOURCE_SELECTION__SELECTION);
		createEAttribute(resourceSelectionEClass, RESOURCE_SELECTION__NAME);
		createEAttribute(resourceSelectionEClass, RESOURCE_SELECTION__URI_ELEMENT);
		createEReference(resourceSelectionEClass, RESOURCE_SELECTION__DEFAULT_SERIALIZATION_GROUPS);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getResource_EnableDefaultGetOne(), theEcorePackage.getEBoolean(), "enableDefaultGetOne", "true", 0, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResource_EnableDefaultGetAll(), theEcorePackage.getEBoolean(), "enableDefaultGetAll", "true", 0, 1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResourceSelection_ParentResource(), this.getResource(), this.getResource_Selections(), "parentResource", null, 0, 1, ResourceSelection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResourceSelection_Name(), theEcorePackage.getEString(), "name", null, 1, 1, ResourceSelection.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getResourceSelection_UriElement(), theEcorePackage.getEString(), "uriElement", null, 1, 1, ResourceSelection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceSelection_DefaultSerializationGroups(), theOrmPackage.getSerializationGroup(), null, "defaultSerializationGroups", null, 0, -1, ResourceSelection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
