 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.rest.impl.APIImpl#getResources <em>Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class APIImpl extends MinimalEObjectImpl.Container implements API {
	...
	public EList<Resource> getResources() {
		if (resources == null) {
			resources = new EObjectContainmentEList<Resource>(Resource.class, this, RestPackage.API__RESOURCES);
		}
		return resources;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestPackage.API__RESOURCES:
