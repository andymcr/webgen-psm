...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.jsf.DynamicMenu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.DYNAMIC_MENU__SERVICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.DYNAMIC_MENU__SELECTION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.DYNAMIC_MENU__DYNAMIC_TITLE,
				 true,
				 false,
				 true,
				 null,
