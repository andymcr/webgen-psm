...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.jsf.ForgottenPasswordUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.FORGOTTEN_PASSWORD_UNIT__AUTHENTICATION_SYSTEM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.FORGOTTEN_PASSWORD_UNIT__LOGIN_ID_FIELD,
				 true,
				 false,
				 true,
				 null,
