...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.jsf.Menu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.MENU__OMIT_CAPTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.MENU__CAPTION_CLASS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.MENU__STYLE_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsfPackage.Literals.MENU__LAYOUT_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JsfPackage.Literals.MENU__ENTRIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(JsfPackage.Literals.MENU__ENTRIES,
				 JsfFactory.eINSTANCE.createFixedPageMenuEntry()));

		newChildDescriptors.add
			(createChildParameter
				(JsfPackage.Literals.MENU__ENTRIES,
				 JsfFactory.eINSTANCE.createFixedActionMenuEntry()));

		newChildDescriptors.add
			(createChildParameter
				(JsfPackage.Literals.MENU__ENTRIES,
				 JsfFactory.eINSTANCE.createFixedCommandMenuEntry()));

		newChildDescriptors.add
			(createChildParameter
				(JsfPackage.Literals.MENU__ENTRIES,
				 JsfFactory.eINSTANCE.createEditStaticTextMenuEntry()));

		newChildDescriptors.add
			(createChildParameter
				(JsfPackage.Literals.MENU__ENTRIES,
				 JsfFactory.eINSTANCE.createMenuIncludedElement()));
	}
