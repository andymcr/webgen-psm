...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.orm.AssociationReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationReferenceItemProvider 
	...
	public String getText(Object object) {
		String label = ((AssociationReference)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AssociationReference.class)) {
			case OrmPackage.ASSOCIATION_REFERENCE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case OrmPackage.ASSOCIATION_REFERENCE__CHILD_FEATURE:
