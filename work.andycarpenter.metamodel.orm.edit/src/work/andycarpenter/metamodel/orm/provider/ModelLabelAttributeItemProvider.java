...
import work.andycarpenter.metamodel.orm.ModelLabelAttribute;
import work.andycarpenter.metamodel.orm.OrmPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.orm.ModelLabelAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelLabelAttributeItemProvider extends ModelLabelFeatureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrmPackage.Literals.MODEL_LABEL_ATTRIBUTE__DATE_FORMAT,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModelLabelAttribute.class)) {
			case OrmPackage.MODEL_LABEL_ATTRIBUTE__DATE_FORMAT:
