...
import work.andycarpenter.metamodel.orm.ChildAssociation;
import work.andycarpenter.metamodel.orm.OrmPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.orm.ChildAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChildAssociationItemProvider extends AssociationPathElementItemProvider {
	/**
	...
	public String getText(Object object) {
		ChildAssociation childAssociation = (ChildAssociation)object;
		return getString("_UI_ChildAssociation_type") + " " + childAssociation.name();
	}
