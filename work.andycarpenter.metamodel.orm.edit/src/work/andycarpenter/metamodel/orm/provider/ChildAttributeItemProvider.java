...
import work.andycarpenter.metamodel.orm.ChildAttribute;
import work.andycarpenter.metamodel.orm.OrmPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.orm.ChildAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChildAttributeItemProvider extends AttributePathElementItemProvider {
	/**
	...
	public String getText(Object object) {
		ChildAttribute childAttribute = (ChildAttribute)object;
		return getString("_UI_ChildAttribute_type") + " " + childAttribute.name();
	}
