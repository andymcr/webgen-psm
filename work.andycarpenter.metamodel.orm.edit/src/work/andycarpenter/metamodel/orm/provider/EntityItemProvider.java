...
import work.andycarpenter.metamodel.base.provider.ClassifierItemProvider;
...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.orm.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ClassifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrmPackage.Literals.ENTITY__IMPLEMENTS_PASSWORD_AUTHENTICATED_INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			...
			case OrmPackage.ENTITY__IMPLEMENTS_PASSWORD_AUTHENTICATED_INTERFACE:
