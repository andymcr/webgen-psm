 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.expression.impl.PredicateIsNullImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PredicateIsNullImpl extends PredicateImpl implements PredicateIsNull {
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.PREDICATE_IS_NULL;
	}
	...
	public void setFeature(Variable newFeature) {
		if (newFeature != feature) {
			...
			if (feature != null)
				msgs = ((InternalEObject)feature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExpressionPackage.PREDICATE_IS_NULL__FEATURE, null, msgs);
			if (newFeature != null)
				msgs = ((InternalEObject)newFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExpressionPackage.PREDICATE_IS_NULL__FEATURE, null, msgs);
			msgs = basicSetFeature(newFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.PREDICATE_IS_NULL__FEATURE, newFeature, newFeature));
	}
