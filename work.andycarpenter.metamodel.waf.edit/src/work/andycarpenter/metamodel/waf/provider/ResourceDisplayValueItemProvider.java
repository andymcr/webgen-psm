...
import work.andycarpenter.metamodel.orm.provider.ResourcePathElementItemProvider;
import work.andycarpenter.metamodel.waf.ResourceDisplayValue;
import work.andycarpenter.metamodel.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.waf.ResourceDisplayValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceDisplayValueItemProvider extends ResourcePathElementItemProvider {
	...
	public String getText(Object object) {
		...
		return getString("_UI_ResourceDisplayValue_type") + " " + resourceDisplayValue.name();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ResourceDisplayValue.class)) {
			case WafPackage.RESOURCE_DISPLAY_VALUE__IS_REQUIRED:
			case WafPackage.RESOURCE_DISPLAY_VALUE__IS_SINGLETON:
