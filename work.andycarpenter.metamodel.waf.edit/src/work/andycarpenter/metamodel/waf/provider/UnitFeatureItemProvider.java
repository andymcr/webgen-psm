...
public class UnitFeatureItemProvider extends DisplayElementItemProvider {
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnitFeature.class)) {
			...
			case WafPackage.UNIT_FEATURE__IS_FEATURE_FIELD:
			...
			case WafPackage.UNIT_FEATURE__HAS_ACTIONS_WITH_DISABLED_MESSAGE:
			case WafPackage.UNIT_FEATURE__HAS_ACTIONS_WITH_SUCCESS_MESSAGE:
