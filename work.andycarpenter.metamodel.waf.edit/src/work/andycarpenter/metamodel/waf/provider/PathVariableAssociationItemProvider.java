...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.waf.PathVariableAssociation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathVariableAssociationItemProvider extends PathAssociationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PathVariableAssociationItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PathVariableAssociation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PathVariableAssociation"));
	}
	...
	public String getText(Object object) {
		String label = ((PathVariableAssociation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PathVariableAssociation_type") :
			getString("_UI_PathVariableAssociation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PathVariableAssociation.class)) {
			case WafPackage.PATH_VARIABLE_ASSOCIATION__SUFFIXES:
			case WafPackage.PATH_VARIABLE_ASSOCIATION__USE_CONTAINER_AS_CONTEXT:
