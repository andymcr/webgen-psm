...
import work.andycarpenter.metamodel.orm.provider.AttributePathElementItemProvider;
import work.andycarpenter.metamodel.waf.AttributeDisplayValue;
import work.andycarpenter.metamodel.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.waf.AttributeDisplayValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeDisplayValueItemProvider extends AttributePathElementItemProvider {
	...
	public String getText(Object object) {
		...
		return getString("_UI_AttributeDisplayValue_type") + " " + attributeDisplayValue.isIsRequired();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AttributeDisplayValue.class)) {
			case WafPackage.ATTRIBUTE_DISPLAY_VALUE__IS_REQUIRED:
			case WafPackage.ATTRIBUTE_DISPLAY_VALUE__IS_SINGLETON:
