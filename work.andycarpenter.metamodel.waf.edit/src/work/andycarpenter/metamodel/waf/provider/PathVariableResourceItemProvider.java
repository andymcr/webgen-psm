...
import work.andycarpenter.metamodel.waf.PathVariableResource;
import work.andycarpenter.metamodel.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.waf.PathVariableResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathVariableResourceItemProvider extends PathResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PathVariableResourceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PathVariableResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PathVariableResource"));
	}
	...
	public String getText(Object object) {
		String label = ((PathVariableResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PathVariableResource_type") :
			getString("_UI_PathVariableResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PathVariableResource.class)) {
			case WafPackage.PATH_VARIABLE_RESOURCE__SUFFIXES:
			case WafPackage.PATH_VARIABLE_RESOURCE__USE_CONTAINER_AS_CONTEXT:
