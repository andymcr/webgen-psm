...
import work.andycarpenter.metamodel.waf.PathVariable;
import work.andycarpenter.metamodel.waf.WafPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.waf.PathVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathVariableItemProvider extends PathItemProvider {
	/**
	...
	public String getText(Object object) {
		PathVariable pathVariable = (PathVariable)object;
		return getString("_UI_PathVariable_type") + " " + pathVariable.isHasChild();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PathVariable.class)) {
			case WafPackage.PATH_VARIABLE__SUFFIXES:
			case WafPackage.PATH_VARIABLE__USE_CONTAINER_AS_CONTEXT:
