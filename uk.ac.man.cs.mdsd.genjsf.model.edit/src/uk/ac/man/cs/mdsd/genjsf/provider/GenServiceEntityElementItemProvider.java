...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.genjsf.GenServiceEntityElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenServiceEntityElementItemProvider
	 ...
	 * @generated
	 */
	public GenServiceEntityElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GenServiceEntityElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GenServiceEntityElement_type") :
			getString("_UI_GenServiceEntityElement_type") + " " + label;
	}
