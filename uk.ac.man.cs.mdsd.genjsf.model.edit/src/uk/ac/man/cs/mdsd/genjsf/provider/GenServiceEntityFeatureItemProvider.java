...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.genjsf.GenServiceEntityFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenServiceEntityFeatureItemProvider
	 ...
	 * @generated
	 */
	public GenServiceEntityFeatureItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((GenServiceEntityFeature)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GenServiceEntityFeature_type") :
			getString("_UI_GenServiceEntityFeature_type") + " " + label;
	}
