 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.criteria.impl.TimeLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeLiteralImpl extends MinimalEObjectImpl.Container implements TimeLiteral {
	...
	protected EClass eStaticClass() {
		return CriteriaPackage.Literals.TIME_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CriteriaPackage.TIME_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CriteriaPackage.TIME_LITERAL__VALUE:
				return getValue();
		}
