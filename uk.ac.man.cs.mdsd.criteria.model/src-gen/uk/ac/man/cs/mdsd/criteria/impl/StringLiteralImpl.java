 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.criteria.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralImpl extends MinimalEObjectImpl.Container implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return CriteriaPackage.Literals.STRING_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CriteriaPackage.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CriteriaPackage.STRING_LITERAL__VALUE:
				return getValue();
		}
