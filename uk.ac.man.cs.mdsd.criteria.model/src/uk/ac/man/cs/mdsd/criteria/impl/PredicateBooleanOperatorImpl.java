 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.criteria.impl.PredicateBooleanOperatorImpl#getExpressions <em>Expressions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.criteria.impl.PredicateBooleanOperatorImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PredicateBooleanOperatorImpl extends PredicateImpl implements PredicateBooleanOperator {
	...
	protected EClass eStaticClass() {
		return CriteriaPackage.Literals.PREDICATE_BOOLEAN_OPERATOR;
	}
	...
	public EList<Predicate> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Predicate>(Predicate.class, this, CriteriaPackage.PREDICATE_BOOLEAN_OPERATOR__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public void setOperator(BooleanOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CriteriaPackage.PREDICATE_BOOLEAN_OPERATOR__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CriteriaPackage.PREDICATE_BOOLEAN_OPERATOR__EXPRESSIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CriteriaPackage.PREDICATE_BOOLEAN_OPERATOR__OPERATOR:
				return getOperator();
		}
