...
public class FixedActionMenuEntryImpl extends MenuEntryImpl implements FixedActionMenuEntry {
	...
	public DynamicUnit getAction() {
		if (action != null && action.eIsProxy()) {
			...
			if (action != oldAction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WafPackage.FIXED_ACTION_MENU_ENTRY__ACTION, oldAction, action));
			}
		}
		return action;
	}
	...
	public void setAction(DynamicUnit newAction) {
		...
		action = newAction;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.FIXED_ACTION_MENU_ENTRY__ACTION, oldAction, action));
	}
