...
public class ModelLabelImpl extends NamedElementImpl implements ModelLabel {
	 ...
	 * @generated
	 */
	public Service basicGetLabelFor() {
		if (eContainerFeatureID() != WafPackage.MODEL_LABEL__LABEL_FOR) return null;
	...
	public EList<ModelLabelFeature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<ModelLabelFeature>(ModelLabelFeature.class, this, WafPackage.MODEL_LABEL__FEATURES);
		}
		return features;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WafPackage.MODEL_LABEL__LABEL_FOR:
				if (resolve) return getLabelFor();
				return basicGetLabelFor();
