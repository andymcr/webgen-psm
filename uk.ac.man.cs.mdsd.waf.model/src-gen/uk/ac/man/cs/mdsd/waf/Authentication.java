 ...
 *   <li>{@link uk.ac.man.cs.mdsd.waf.Authentication#getUser <em>User</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.Authentication#getUserKey <em>User Key</em>}</li>
...
public interface Authentication extends EObject {
	 ...
	 * @see uk.ac.man.cs.mdsd.waf.WafPackage#getAuthentication_UserKey()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link uk.ac.man.cs.mdsd.waf.Authentication#getUserKey <em>User Key</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
