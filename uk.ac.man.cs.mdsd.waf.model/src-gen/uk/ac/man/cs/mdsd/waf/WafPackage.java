...
public interface WafPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SERVICE__SERVES = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE__SELECTIONS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SERVICE__OPERATIONS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SELECTION__DISTINCT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SELECTION__FIELDS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SELECTION__JOINS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SELECTION__FILTER = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int SELECTION__ORDERING = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SELECTION__LIMIT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SELECTION_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 8;
	...
	/**
	 * The meta object id for the '{@link uk.ac.man.cs.mdsd.waf.impl.BusinessOperationImpl <em>Business Operation</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see uk.ac.man.cs.mdsd.waf.impl.BusinessOperationImpl
	 ...
	 * @ordered
	 */
	int FILTER__NAME = OrmPackage.NAMED_DISPLAY_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int FILTER__DISPLAY_LABEL = OrmPackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL;
	 ...
	 * @ordered
	 */
	int FILTER__PARAMETERS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FILTER__SELECTION = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FILTER_FEATURE_COUNT = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FILTER_OPERATION_COUNT = OrmPackage.NAMED_DISPLAY_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FILTER_PARAMETER__PLACEHOLDER = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int FILTER_PARAMETER_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int UNIT_FIELD__COLLECTION_ALLOW_ADD = DISPLAY_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int UNIT_FIELD__COLLECTION_ALLOW_REMOVE = DISPLAY_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int INTERFACE_FIELD__COLLECTION_ALLOW_ADD = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int INTERFACE_FIELD__COLLECTION_ALLOW_REMOVE = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__USE_DISABLED_PAGE_LINKS = DATA_UNIT_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS = DATA_UNIT_FEATURE_COUNT + 11;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__FIRST_PAGE_LABEL = DATA_UNIT_FEATURE_COUNT + 12;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__LAST_PAGE_LABEL = DATA_UNIT_FEATURE_COUNT + 13;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__TARGETTING_SEARCHES = DATA_UNIT_FEATURE_COUNT + 14;
	...
	/**
	 * The meta object id for the '{@link uk.ac.man.cs.mdsd.waf.impl.IndexImageGridUnitImpl <em>Index Image Grid Unit</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see uk.ac.man.cs.mdsd.waf.impl.IndexImageGridUnitImpl
	 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getIndexImageGridUnit()
	 * @generated
	 */
	int INDEX_IMAGE_GRID_UNIT = 54;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__NAME = INDEX_UNIT__NAME;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__DISPLAY_LABEL = INDEX_UNIT__DISPLAY_LABEL;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__DISPLAYED_ON = INDEX_UNIT__DISPLAYED_ON;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__PURPOSE_SUMMARY = INDEX_UNIT__PURPOSE_SUMMARY;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__REQUIRES_ROLE = INDEX_UNIT__REQUIRES_ROLE;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__URI_ELEMENT = INDEX_UNIT__URI_ELEMENT;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__ALTERNATIVE = INDEX_UNIT__ALTERNATIVE;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__OMIT_CAPTION = INDEX_UNIT__OMIT_CAPTION;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__CAPTION_CLASS = INDEX_UNIT__CAPTION_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__STYLE_CLASS = INDEX_UNIT__STYLE_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__CONTENT_CLASS = INDEX_UNIT__CONTENT_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__ENTITIES = INDEX_UNIT__ENTITIES;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__DISPLAY_FIELDS = INDEX_UNIT__DISPLAY_FIELDS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__SUPPORT_ACTIONS = INDEX_UNIT__SUPPORT_ACTIONS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__KEY_ACTUALS = INDEX_UNIT__KEY_ACTUALS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__HEADER = INDEX_UNIT__HEADER;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__FOOTER = INDEX_UNIT__FOOTER;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__HEADER_CLASS = INDEX_UNIT__HEADER_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__CONTROL_CLASS = INDEX_UNIT__CONTROL_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__FOOTER_CLASS = INDEX_UNIT__FOOTER_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__ERROR_CLASS = INDEX_UNIT__ERROR_CLASS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__DEFAULT_SELECTION = INDEX_UNIT__DEFAULT_SELECTION;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__TITLE = INDEX_UNIT__TITLE;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__ACTIONS = INDEX_UNIT__ACTIONS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__OMIT_COLUMN_LABELS = INDEX_UNIT__OMIT_COLUMN_LABELS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__FILTERS = INDEX_UNIT__FILTERS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__PAGINATION = INDEX_UNIT__PAGINATION;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__DEFAULT_PAGINATION_SIZE = INDEX_UNIT__DEFAULT_PAGINATION_SIZE;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__EMPTY_MESSAGE = INDEX_UNIT__EMPTY_MESSAGE;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__NEXT_NPAGES = INDEX_UNIT__NEXT_NPAGES;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__PREVIOUS_NPAGES = INDEX_UNIT__PREVIOUS_NPAGES;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__NEXT_PAGE_LABEL = INDEX_UNIT__NEXT_PAGE_LABEL;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__PREVIOUS_PAGE_LABEL = INDEX_UNIT__PREVIOUS_PAGE_LABEL;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__USE_DISABLED_PAGE_LINKS = INDEX_UNIT__USE_DISABLED_PAGE_LINKS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__USE_FIRST_LAST_PAGE_LINKS = INDEX_UNIT__USE_FIRST_LAST_PAGE_LINKS;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__FIRST_PAGE_LABEL = INDEX_UNIT__FIRST_PAGE_LABEL;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__LAST_PAGE_LABEL = INDEX_UNIT__LAST_PAGE_LABEL;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__TARGETTING_SEARCHES = INDEX_UNIT__TARGETTING_SEARCHES;
	 ...
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT__ROW_CLASSES = INDEX_UNIT__ROW_CLASSES;

	/**
	 * The number of structural features of the '<em>Index Image Grid Unit</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT_FEATURE_COUNT = INDEX_UNIT_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Index Image Grid Unit</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INDEX_IMAGE_GRID_UNIT_OPERATION_COUNT = INDEX_UNIT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ACTION_UNIT_FEATURE_COUNT = CONTROL_UNIT_FEATURE_COUNT + 0;
	 ...
	 * @generated
	 */
	int FEATURE_PATH_ASSOCIATION = 61;
	 ...
	 * @ordered
	 */
	int FEATURE_PATH_ASSOCIATION_FEATURE_COUNT = FEATURE_PATH_FEATURE_COUNT + 3;
	 ...
	 * @generated
	 */
	int FORGOTTEN_PASSWORD_UNIT = 70;
	 ...
	 * @generated
	 */
	int INLINE_ACTION_CONTAINER = 71;
	 ...
	 * @generated
	 */
	int ROUTE_PARAMETER_REFERENCE = 79;
	 ...
	 * @generated
	 */
	int AUTHENTICATION_KEY_TYPES = 84;
	 ...
	 * @generated
	 */
	int COLLECTION_DISPLAY_OPTIONS = 87;
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.WafModel#isResponsiveTopMenu <em>Responsive Top Menu</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Responsive Top Menu</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.WafModel#isResponsiveTopMenu()
	 * @see #getWafModel()
	 * @generated
	 */
	EAttribute getWafModel_ResponsiveTopMenu();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link uk.ac.man.cs.mdsd.waf.Service#getOperations <em>Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.Selection#isDistinct <em>Distinct</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Distinct</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.Selection#isDistinct()
	 * @see #getSelection()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link uk.ac.man.cs.mdsd.waf.BusinessOperation <em>Business Operation</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link uk.ac.man.cs.mdsd.waf.BusinessOperation#getPartOf <em>Part Of</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Part Of</em>'.
	 ...
	 * @see uk.ac.man.cs.mdsd.waf.BusinessOperation#getResultType()
	 * @see #getBusinessOperation()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.BusinessOperation#getResultMimeType <em>Result Mime Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Result Mime Type</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.BusinessOperation#getResultMimeType()
	 * @see #getBusinessOperation()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.FilterParameter#getPlaceholder <em>Placeholder</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Placeholder</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.FilterParameter#getPlaceholder()
	 * @see #getFilterParameter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link uk.ac.man.cs.mdsd.waf.IndexImageGridUnit <em>Index Image Grid Unit</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Index Image Grid Unit</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IndexImageGridUnit
	 * @generated
	 */
	EClass getIndexImageGridUnit();
	...
	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.ImageUnit#getDefaultSelection <em>Default Selection</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Default Selection</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.ImageUnit#getDefaultSelection()
	 * @see #getImageUnit()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.FeaturePathAssociation#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.FeaturePathAssociation#getName()
	 ...
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Enable When</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.InlineAction#getEnableWhen()
	 * @see #getInlineAction()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link uk.ac.man.cs.mdsd.waf.OperationResultTypes <em>Operation Result Types</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute WAF_MODEL__RESPONSIVE_TOP_MENU = eINSTANCE.getWafModel_ResponsiveTopMenu();
		...
		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.impl.BusinessOperationImpl <em>Business Operation</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.impl.BusinessOperationImpl
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getBusinessOperation()
		...
		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.impl.IndexImageGridUnitImpl <em>Index Image Grid Unit</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.impl.IndexImageGridUnitImpl
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getIndexImageGridUnit()
		 * @generated
		 */
		EClass INDEX_IMAGE_GRID_UNIT = eINSTANCE.getIndexImageGridUnit();
		...
		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.OperationResultTypes <em>Operation Result Types</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.OperationResultTypes
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getOperationResultTypes()
