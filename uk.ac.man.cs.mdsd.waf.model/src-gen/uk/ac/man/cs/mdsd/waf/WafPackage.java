...
public interface WafPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__FORCED_VALUE = 0;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__FOOTER = 1;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__HEADER_CLASS = 2;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__INPUT_CLASS = 3;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__DISPLAY_CLASS = 4;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE__FOOTER_CLASS = 5;
	 ...
	 * @ordered
	 */
	int INCLUDED_FEATURE_FEATURE_COUNT = 6;
	...
	/**
	 * The meta object id for the '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute <em>Included Attribute</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute
	 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getIncludedAttribute()
	 * @generated
	 */
	int INCLUDED_ATTRIBUTE = 5;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__FORCED_VALUE = INCLUDED_FEATURE__FORCED_VALUE;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__FOOTER = INCLUDED_FEATURE__FOOTER;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__HEADER_CLASS = INCLUDED_FEATURE__HEADER_CLASS;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__INPUT_CLASS = INCLUDED_FEATURE__INPUT_CLASS;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__DISPLAY_CLASS = INCLUDED_FEATURE__DISPLAY_CLASS;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__FOOTER_CLASS = INCLUDED_FEATURE__FOOTER_CLASS;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__ATTRIBUTE = INCLUDED_FEATURE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__OBFUSCATE_FORM_FIELDS = INCLUDED_FEATURE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE__DEFAULT_VALUE = INCLUDED_FEATURE_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Included Attribute</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE_FEATURE_COUNT = INCLUDED_FEATURE_FEATURE_COUNT + 3;

	/**
	 * The number of operations of the '<em>Included Attribute</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INCLUDED_ATTRIBUTE_OPERATION_COUNT = INCLUDED_FEATURE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INCLUDED_ASSOCIATION_FEATURE_COUNT = INCLUDED_FEATURE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE__SELECTIONS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE__ACCESSED_BY = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__FORCED_VALUE = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__FOOTER = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__HEADER_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__INPUT_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__DISPLAY_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__FOOTER_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__PART_OF = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SERVICE_FEATURE__CARDINALITY = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__ATTRIBUTE = SERVICE_FEATURE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__OBFUSCATE_FORM_FIELDS = SERVICE_FEATURE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__DEFAULT_VALUE = SERVICE_FEATURE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__CASE_INSENSITIVE = SERVICE_FEATURE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__ENCRYPT = SERVICE_FEATURE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__INTERFACE_TYPE = SERVICE_FEATURE_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__PLACEHOLDER = SERVICE_FEATURE_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__VALIDATION_PATTERN = SERVICE_FEATURE_FEATURE_COUNT + 7;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE__DATE_FORMAT = SERVICE_FEATURE_FEATURE_COUNT + 8;
	 ...
	 * @ordered
	 */
	int SERVICE_ATTRIBUTE_FEATURE_COUNT = SERVICE_FEATURE_FEATURE_COUNT + 9;
	 ...
	 * @ordered
	 */
	int QUERY_PARAMETER__PARAMETER = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QUERY_PARAMETER__DATA_TYPE = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int QUERY_PARAMETER__DEFAULT_VALUE = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int QUERY_PARAMETER_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link uk.ac.man.cs.mdsd.waf.impl.QueryInstanceImpl <em>Query Instance</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see uk.ac.man.cs.mdsd.waf.impl.QueryInstanceImpl
	 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getQueryInstance()
	 * @generated
	 */
	int QUERY_INSTANCE = 27;
	 ...
	 * @ordered
	 */
	int QUERY_INSTANCE__NAME = OrmPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int QUERY_INSTANCE__QUERY = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QUERY_INSTANCE__ACTUALS = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Query Instance</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int QUERY_INSTANCE_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Query Instance</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int QUERY_INSTANCE_OPERATION_COUNT = OrmPackage.NAMED_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link uk.ac.man.cs.mdsd.waf.impl.QueryActualImpl <em>Query Actual</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see uk.ac.man.cs.mdsd.waf.impl.QueryActualImpl
	 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getQueryActual()
	 * @generated
	 */
	int QUERY_ACTUAL = 28;
	 ...
	 * @ordered
	 */
	int QUERY_ACTUAL__NAME = OrmPackage.NAMED_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int QUERY_ACTUAL__PARAMETER = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int QUERY_ACTUAL__VALUE = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>Query Actual</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int QUERY_ACTUAL_FEATURE_COUNT = OrmPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of operations of the '<em>Query Actual</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int QUERY_ACTUAL_OPERATION_COUNT = OrmPackage.NAMED_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__NAME = OrmPackage.NAMED_DISPLAY_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__DISPLAY_LABEL = OrmPackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__FORCED_VALUE = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__FOOTER = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__HEADER_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__INPUT_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__DISPLAY_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__FOOTER_CLASS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__DISPLAYED_ON = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE__AUTOFOCUS = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 13;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE_FEATURE_COUNT = OrmPackage.NAMED_DISPLAY_ELEMENT_FEATURE_COUNT + 14;
	 ...
	 * @ordered
	 */
	int UNIT_FEATURE_OPERATION_COUNT = OrmPackage.NAMED_DISPLAY_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int UNIT_ELEMENT__OBFUSCATE_FORM_FIELDS = UNIT_FEATURE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int UNIT_ELEMENT__SERVICE_FEATURE = UNIT_FEATURE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int UNIT_ASSOCIATION__UNITS = UNIT_FEATURE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int UNIT_ASSOCIATION__SERVICE_FEATURE = UNIT_FEATURE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int UNIT_ASSOCIATION__DYNAMIC_LABEL = UNIT_FEATURE_FEATURE_COUNT + 5;
	...
	/**
	 * The feature id for the '<em><b>Selection Features</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CREATE_UPDATE_UNIT__SELECTION_FEATURES = EDIT_UNIT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MAP_UNIT__SELECTION_FEATURES = EDIT_UNIT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int UPDATE_UNIT__SELECTION_FEATURES = EDIT_UNIT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int DETAILS_UNIT__SELECTION_FEATURES = DATA_UNIT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int INDEX_UNIT__PAGINATION_QUERY = DATA_UNIT_FEATURE_COUNT + 2;
	 ...
	 * @generated
	 */
	int INDEX_PAGE_DIRECTION_UNIT = 57;
	 ...
	 * @generated
	 */
	int INDEX_LINE_DIRECTION_UNIT = 58;
	 ...
	 * @ordered
	 */
	int SELECT_TARGET__SELECTION_FEATURES = 1;
	...
	/**
	 * Returns the meta object for class '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute <em>Included Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Included Attribute</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute
	 * @generated
	 */
	EClass getIncludedAttribute();

	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute#getAttribute <em>Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Attribute</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute#getAttribute()
	 * @see #getIncludedAttribute()
	 * @generated
	 */
	EReference getIncludedAttribute_Attribute();

	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute#isObfuscateFormFields <em>Obfuscate Form Fields</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Obfuscate Form Fields</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute#isObfuscateFormFields()
	 * @see #getIncludedAttribute()
	 * @generated
	 */
	EAttribute getIncludedAttribute_ObfuscateFormFields();

	/**
	 * Returns the meta object for the containment reference '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute#getDefaultValue <em>Default Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Default Value</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute#getDefaultValue()
	 * @see #getIncludedAttribute()
	 * @generated
	 */
	EReference getIncludedAttribute_DefaultValue();
	...
	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.IncludedAssociation#getAssociation <em>Association</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Association</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.IncludedAssociation#getAssociation()
	...
	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.ServiceAttribute#isCaseInsensitive <em>Case Insensitive</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Case Insensitive</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.ServiceAttribute#isCaseInsensitive()
	 * @see #getServiceAttribute()
	 * @generated
	 */
	EAttribute getServiceAttribute_CaseInsensitive();

	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.ServiceAttribute#isEncrypt <em>Encrypt</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Encrypt</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.ServiceAttribute#isEncrypt()
	 * @see #getServiceAttribute()
	 * @generated
	 */
	EAttribute getServiceAttribute_Encrypt();
	...
	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.QueryParameter#getParameter <em>Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Parameter</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryParameter#getParameter()
	 * @see #getQueryParameter()
	 * @generated
	 */
	EReference getQueryParameter_Parameter();

	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.QueryParameter#getDataType <em>Data Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Data Type</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryParameter#getDataType()
	 * @see #getQueryParameter()
	 * @generated
	 */
	EReference getQueryParameter_DataType();

	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.QueryParameter#getDefaultValue <em>Default Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Default Value</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryParameter#getDefaultValue()
	 * @see #getQueryParameter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link uk.ac.man.cs.mdsd.waf.QueryInstance <em>Query Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Query Instance</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryInstance
	 * @generated
	 */
	EClass getQueryInstance();

	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.QueryInstance#getQuery <em>Query</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Query</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryInstance#getQuery()
	 * @see #getQueryInstance()
	 * @generated
	 */
	EReference getQueryInstance_Query();

	/**
	 * Returns the meta object for the containment reference list '{@link uk.ac.man.cs.mdsd.waf.QueryInstance#getActuals <em>Actuals</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Actuals</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryInstance#getActuals()
	 * @see #getQueryInstance()
	 * @generated
	 */
	EReference getQueryInstance_Actuals();

	/**
	 * Returns the meta object for class '{@link uk.ac.man.cs.mdsd.waf.QueryActual <em>Query Actual</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Query Actual</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryActual
	 * @generated
	 */
	EClass getQueryActual();

	/**
	 * Returns the meta object for the reference '{@link uk.ac.man.cs.mdsd.waf.QueryActual#getParameter <em>Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Parameter</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryActual#getParameter()
	 * @see #getQueryActual()
	 * @generated
	 */
	EReference getQueryActual_Parameter();

	/**
	 * Returns the meta object for the attribute '{@link uk.ac.man.cs.mdsd.waf.QueryActual#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.QueryActual#getValue()
	 * @see #getQueryActual()
	 * @generated
	 */
	EAttribute getQueryActual_Value();
	...
	/**
	 * Returns the meta object for the reference list '{@link uk.ac.man.cs.mdsd.waf.SelectTarget#getSelectionFeatures <em>Selection Features</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Selection Features</em>'.
	 * @see uk.ac.man.cs.mdsd.waf.SelectTarget#getSelectionFeatures()
	 * @see #getSelectTarget()
	 * @generated
	 */
	EReference getSelectTarget_SelectionFeatures();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.IncludedAttribute <em>Included Attribute</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.IncludedAttribute
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getIncludedAttribute()
		 * @generated
		 */
		EClass INCLUDED_ATTRIBUTE = eINSTANCE.getIncludedAttribute();
		 ...
		 * @generated
		 */
		EReference INCLUDED_ATTRIBUTE__ATTRIBUTE = eINSTANCE.getIncludedAttribute_Attribute();
		 ...
		 * @generated
		 */
		EAttribute INCLUDED_ATTRIBUTE__OBFUSCATE_FORM_FIELDS = eINSTANCE.getIncludedAttribute_ObfuscateFormFields();
		 ...
		 * @generated
		 */
		EReference INCLUDED_ATTRIBUTE__DEFAULT_VALUE = eINSTANCE.getIncludedAttribute_DefaultValue();
		 ...
		 * @generated
		 */
		EAttribute SERVICE_ATTRIBUTE__CASE_INSENSITIVE = eINSTANCE.getServiceAttribute_CaseInsensitive();
		 ...
		 * @generated
		 */
		EAttribute SERVICE_ATTRIBUTE__ENCRYPT = eINSTANCE.getServiceAttribute_Encrypt();
		 ...
		 * @generated
		 */
		EReference QUERY_PARAMETER__PARAMETER = eINSTANCE.getQueryParameter_Parameter();
		 ...
		 * @generated
		 */
		EReference QUERY_PARAMETER__DATA_TYPE = eINSTANCE.getQueryParameter_DataType();
		...
		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.impl.QueryInstanceImpl <em>Query Instance</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.impl.QueryInstanceImpl
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getQueryInstance()
		 * @generated
		 */
		EClass QUERY_INSTANCE = eINSTANCE.getQueryInstance();
		 ...
		 * @generated
		 */
		EReference QUERY_INSTANCE__QUERY = eINSTANCE.getQueryInstance_Query();
		 ...
		 * @generated
		 */
		EReference QUERY_INSTANCE__ACTUALS = eINSTANCE.getQueryInstance_Actuals();

		/**
		 * The meta object literal for the '{@link uk.ac.man.cs.mdsd.waf.impl.QueryActualImpl <em>Query Actual</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see uk.ac.man.cs.mdsd.waf.impl.QueryActualImpl
		 * @see uk.ac.man.cs.mdsd.waf.impl.WafPackageImpl#getQueryActual()
		 * @generated
		 */
		EClass QUERY_ACTUAL = eINSTANCE.getQueryActual();
		 ...
		 * @generated
		 */
		EReference QUERY_ACTUAL__PARAMETER = eINSTANCE.getQueryActual_Parameter();
		 ...
		 * @generated
		 */
		EAttribute QUERY_ACTUAL__VALUE = eINSTANCE.getQueryActual_Value();
		...
		/**
		 * The meta object literal for the '<em><b>Selection Features</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SELECT_TARGET__SELECTION_FEATURES = eINSTANCE.getSelectTarget_SelectionFeatures();
