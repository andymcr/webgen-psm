...
public class SelectionParameterImpl extends NamedElementImpl implements SelectionParameter {
	...
	protected EClass eStaticClass() {
		return WafPackage.Literals.SELECTION_PARAMETER;
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SELECTION_PARAMETER__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
