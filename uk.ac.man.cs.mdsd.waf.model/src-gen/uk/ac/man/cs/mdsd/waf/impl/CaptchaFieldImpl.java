...
public class CaptchaFieldImpl extends NamedDisplayElementImpl implements CaptchaField {
	...
	protected EClass eStaticClass() {
		return WafPackage.Literals.CAPTCHA_FIELD;
	}
	...
	public DynamicUnit getDisplayedOn() {
		if (eContainerFeatureID() != WafPackage.CAPTCHA_FIELD__DISPLAYED_ON) return null;
	...
	public NotificationChain basicSetDisplayedOn(DynamicUnit newDisplayedOn, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDisplayedOn, WafPackage.CAPTCHA_FIELD__DISPLAYED_ON, msgs);
		return msgs;
	}
	...
	public void setDisplayedOn(DynamicUnit newDisplayedOn) {
		if (newDisplayedOn != eInternalContainer() || (eContainerFeatureID() != WafPackage.CAPTCHA_FIELD__DISPLAYED_ON && newDisplayedOn != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.CAPTCHA_FIELD__DISPLAYED_ON, newDisplayedOn, newDisplayedOn));
	}
	...
	public void setCardinality(Cardinality newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.CAPTCHA_FIELD__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.CAPTCHA_FIELD__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WafPackage.CAPTCHA_FIELD__DISPLAYED_ON:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
