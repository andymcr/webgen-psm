 ...
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getDisplayClass <em>Display Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.ServiceEntityFeatureImpl#getViewColumnName <em>View Column Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ServiceEntityFeatureImpl extends MinimalEObjectImpl.Container implements ServiceEntityFeature {
	/**
	...
	protected EClass eStaticClass() {
		return WafPackage.Literals.SERVICE_ENTITY_FEATURE;
	}
	...
	public Service getIncludedBy() {
		if (eContainerFeatureID() != WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY) return null;
	 ...
	 * @generated
	 */
	public Service basicGetIncludedBy() {
		if (eContainerFeatureID() != WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY) return null;
	...
	public NotificationChain basicSetIncludedBy(Service newIncludedBy, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newIncludedBy, WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY, msgs);
		return msgs;
	}
	...
	public void setIncludedBy(Service newIncludedBy) {
		if (newIncludedBy != eInternalContainer() || (eContainerFeatureID() != WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY && newIncludedBy != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY, newIncludedBy, newIncludedBy));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__NAME, oldName, name));
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public NotificationChain basicSetForcedValue(Expression newForcedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, oldForcedValue, newForcedValue);
	...
	public void setForcedValue(Expression newForcedValue) {
		if (newForcedValue != forcedValue) {
			NotificationChain msgs = null;
			if (forcedValue != null)
				msgs = ((InternalEObject)forcedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, null, msgs);
			if (newForcedValue != null)
				msgs = ((InternalEObject)newForcedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, null, msgs);
			msgs = basicSetForcedValue(newForcedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, newForcedValue, newForcedValue));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__FOOTER, oldFooter, footer));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setDisplayClass(String newDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_CLASS, oldDisplayClass, displayClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public void setViewColumnName(String newViewColumnName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.SERVICE_ENTITY_FEATURE__VIEW_COLUMN_NAME, oldViewColumnName, viewColumnName));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WafPackage.SERVICE_ENTITY_FEATURE__INCLUDED_BY:
				if (resolve) return getIncludedBy();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case WafPackage.SERVICE_ENTITY_FEATURE__NAME: return OrmPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == IncludedFeature.class) {
			switch (derivedFeatureID) {
				case WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_LABEL: return WafPackage.INCLUDED_FEATURE__DISPLAY_LABEL;
				case WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE: return WafPackage.INCLUDED_FEATURE__FORCED_VALUE;
				case WafPackage.SERVICE_ENTITY_FEATURE__FOOTER: return WafPackage.INCLUDED_FEATURE__FOOTER;
				case WafPackage.SERVICE_ENTITY_FEATURE__HEADER_CLASS: return WafPackage.INCLUDED_FEATURE__HEADER_CLASS;
				case WafPackage.SERVICE_ENTITY_FEATURE__INPUT_CLASS: return WafPackage.INCLUDED_FEATURE__INPUT_CLASS;
				case WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_CLASS: return WafPackage.INCLUDED_FEATURE__DISPLAY_CLASS;
				case WafPackage.SERVICE_ENTITY_FEATURE__FOOTER_CLASS: return WafPackage.INCLUDED_FEATURE__FOOTER_CLASS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case OrmPackage.NAMED_ELEMENT__NAME: return WafPackage.SERVICE_ENTITY_FEATURE__NAME;
				default: return -1;
			}
		}
		if (baseClass == IncludedFeature.class) {
			switch (baseFeatureID) {
				case WafPackage.INCLUDED_FEATURE__DISPLAY_LABEL: return WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_LABEL;
				case WafPackage.INCLUDED_FEATURE__FORCED_VALUE: return WafPackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE;
				case WafPackage.INCLUDED_FEATURE__FOOTER: return WafPackage.SERVICE_ENTITY_FEATURE__FOOTER;
				case WafPackage.INCLUDED_FEATURE__HEADER_CLASS: return WafPackage.SERVICE_ENTITY_FEATURE__HEADER_CLASS;
				case WafPackage.INCLUDED_FEATURE__INPUT_CLASS: return WafPackage.SERVICE_ENTITY_FEATURE__INPUT_CLASS;
				case WafPackage.INCLUDED_FEATURE__DISPLAY_CLASS: return WafPackage.SERVICE_ENTITY_FEATURE__DISPLAY_CLASS;
				case WafPackage.INCLUDED_FEATURE__FOOTER_CLASS: return WafPackage.SERVICE_ENTITY_FEATURE__FOOTER_CLASS;
				default: return -1;
			}
		}
