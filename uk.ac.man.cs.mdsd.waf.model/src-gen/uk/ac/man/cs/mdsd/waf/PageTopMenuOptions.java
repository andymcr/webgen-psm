 ...
 * <!-- end-user-doc -->
 * @see uk.ac.man.cs.mdsd.waf.WafPackage#getPageTopMenuOptions()
 * @model
 * @generated
 */
public enum PageTopMenuOptions implements Enumerator {
	 ...
	 * @ordered
	 */
	ALWAYS_INCLUDE(1, "AlwaysInclude", "AlwaysInclude"),
	 ...
	 * @ordered
	 */
	INCLUDE_WHEN_AUTHENTICATED(2, "IncludeWhenAuthenticated", "IncludeWhenAuthenticated");
	 ...
	 * @ordered
	 */
	public static final int ALWAYS_INCLUDE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int INCLUDE_WHEN_AUTHENTICATED_VALUE = 2;
	...
	public static PageTopMenuOptions get(int value) {
		switch (value) {
			...
			case ALWAYS_INCLUDE_VALUE: return ALWAYS_INCLUDE;
			case INCLUDE_WHEN_AUTHENTICATED_VALUE: return INCLUDE_WHEN_AUTHENTICATED;
		}
		return null;
	}
