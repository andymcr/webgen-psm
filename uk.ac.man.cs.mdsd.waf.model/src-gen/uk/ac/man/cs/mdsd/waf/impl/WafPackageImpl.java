...
import uk.ac.man.cs.mdsd.waf.IndexImageGridUnit;
...
public class WafPackageImpl extends EPackageImpl implements WafPackage {
	 ...
	 * @generated
	 */
	private EClass indexImageGridUnitEClass = null;
	 ...
	 * @generated
	 */
	public EReference getUnitAssociation_Path() {
	...
	public EReference getIndexUnit_TargettingSearches() {
		return (EReference)indexUnitEClass.getEStructuralFeatures().get(13);
	}
	 ...
	 * @generated
	 */
	public EClass getIndexImageGridUnit() {
		return indexImageGridUnitEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getImageUnit_ThumbnailFilter() {
	 ...
	 * @generated
	 */
	public EAttribute getFeaturePathAssociation_Name() {
	...
	public void createPackageContents() {
		...
		createEReference(unitAssociationEClass, UNIT_ASSOCIATION__PATH);
		...
		indexImageGridUnitEClass = createEClass(INDEX_IMAGE_GRID_UNIT);
		...
		createEReference(imageUnitEClass, IMAGE_UNIT__THUMBNAIL_FILTER);
		...
		createEAttribute(featurePathAssociationEClass, FEATURE_PATH_ASSOCIATION__NAME);
	...
	public void initializePackageContents() {
		...
		indexImageGridUnitEClass.getESuperTypes().add(this.getIndexUnit());
		...
		initEReference(getSelection_Ordering(), theExpressionPackage.getOrder(), null, "ordering", null, 0, -1, Selection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPathReferenceElement_Actual(), theExpressionPackage.getExpression(), null, "actual", null, 1, 1, PathReferenceElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUnitAssociation_Path(), this.getFeaturePathAssociation(), null, "path", null, 1, 1, UnitAssociation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIndexUnit_EmptyMessage(), theEcorePackage.getEString(), "emptyMessage", null, 0, 1, IndexUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(indexImageGridUnitEClass, IndexImageGridUnit.class, "IndexImageGridUnit", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getImageUnit_ThumbnailFilter(), this.getImageManipulation(), null, "thumbnailFilter", null, 1, 1, ImageUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeaturePathAssociation_Name(), theEcorePackage.getEString(), "name", null, 0, 1, FeaturePathAssociation.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
