...
public class WafPackageImpl extends EPackageImpl implements WafPackage {
	...
	public EReference getWafModel_LogoFilters() {
		return (EReference)wafModelEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EAttribute getImageIndexUnit_EnableImageEnlargement() {
	 ...
	 * @generated
	 */
	public EAttribute getImageIndexUnit_RevealUntruncatedContent() {
	...
	public void createPackageContents() {
		...
		createEAttribute(imageIndexUnitEClass, IMAGE_INDEX_UNIT__ENABLE_IMAGE_ENLARGEMENT);
		...
		createEAttribute(imageIndexUnitEClass, IMAGE_INDEX_UNIT__REVEAL_UNTRUNCATED_CONTENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getAuthentication_User(), theOrmPackage.getEntity(), null, "user", null, 1, 1, Authentication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLocalAuthenticationSystem_Authentication(), theOrmPackage.getEntity(), null, "authentication", null, 0, 1, LocalAuthenticationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLocalAuthenticationSystem_LoginAttempt(), theOrmPackage.getEntity(), null, "loginAttempt", null, 0, 1, LocalAuthenticationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLocalAuthenticationSystem_AutoLogin(), theOrmPackage.getEntity(), null, "autoLogin", null, 0, 1, LocalAuthenticationSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSubmenuEntry_RequiresRole(), theEcorePackage.getEString(), "requiresRole", null, 0, 1, SubmenuEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUnitField_Truncate(), theEcorePackage.getEBooleanObject(), "truncate", null, 0, 1, UnitField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSingletonUnit_ContentType(), theOrmPackage.getEntity(), null, "contentType", null, 1, 1, SingletonUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImageUnit_MissingImageFilter(), this.getImageManipulation(), null, "missingImageFilter", null, 0, 1, ImageUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getImageIndexUnit_EnableImageEnlargement(), theEcorePackage.getEBoolean(), "enableImageEnlargement", null, 0, 1, ImageIndexUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getImageIndexUnit_RevealUntruncatedContent(), theEcorePackage.getEBoolean(), "revealUntruncatedContent", null, 0, 1, ImageIndexUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
