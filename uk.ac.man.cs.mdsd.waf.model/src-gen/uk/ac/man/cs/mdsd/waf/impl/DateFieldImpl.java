 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.DateFieldImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.DateFieldImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateFieldImpl extends InterfaceFieldImpl implements DateField
{
  ...
  {
    return WafPackage.Literals.DATE_FIELD;
  }
  ...
  public void setDetails(DateDetails newDetails)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.DATE_FIELD__DETAILS, oldDetails, details));
  }
  ...
  public void setFormat(String newFormat)
  {
    ...
    format = newFormat;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.DATE_FIELD__FORMAT, oldFormat, format));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WafPackage.DATE_FIELD__DETAILS:
        return getDetails();
      case WafPackage.DATE_FIELD__FORMAT:
        return getFormat();
    }
