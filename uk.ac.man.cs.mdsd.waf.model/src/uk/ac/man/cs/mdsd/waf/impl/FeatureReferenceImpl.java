 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.FeatureReferenceImpl#getField <em>Field</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureReferenceImpl extends EObjectImpl implements FeatureReference {
		...
		if (field != null && field.eIsProxy()) {
			...
			if (field != oldField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WafPackage.FEATURE_REFERENCE__FIELD, oldField, field));
			}
		}
		return field;
	}
	...
	public void setField(ServiceEntityFeature newField) {
		...
		field = newField;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WafPackage.FEATURE_REFERENCE__FIELD, oldField, field));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WafPackage.FEATURE_REFERENCE__FIELD:
