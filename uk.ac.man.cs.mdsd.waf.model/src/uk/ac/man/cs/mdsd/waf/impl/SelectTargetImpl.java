 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.waf.impl.SelectTargetImpl#getTargettingActions <em>Targetting Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class SelectTargetImpl extends EObjectImpl implements SelectTarget {
	...
	protected EClass eStaticClass() {
		return WafPackage.Literals.SELECT_TARGET;
	}
	...
	public EList<SelectAction> getTargettingActions() {
		if (targettingActions == null) {
			targettingActions = new EObjectWithInverseResolvingEList<SelectAction>(SelectAction.class, this, WafPackage.SELECT_TARGET__TARGETTING_ACTIONS, WafPackage.SELECT_ACTION__TARGET);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WafPackage.SELECT_TARGET__TARGETTING_ACTIONS:
