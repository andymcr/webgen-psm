 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.BooleanLiteralImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link work.andycarpenter.psms.base.impl.BooleanLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends MinimalEObjectImpl.Container implements BooleanLiteral {
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.BOOLEAN_LITERAL__SUFFIXES);
		}
		return suffixes;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.BOOLEAN_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.BOOLEAN_LITERAL__SUFFIXES:
				return getSuffixes();
