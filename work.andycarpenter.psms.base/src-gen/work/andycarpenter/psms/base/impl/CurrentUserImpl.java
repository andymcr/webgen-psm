 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.CurrentUserImpl#getSuffixes <em>Suffixes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CurrentUserImpl extends MinimalEObjectImpl.Container implements CurrentUser {
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.CURRENT_USER__SUFFIXES);
		}
		return suffixes;
	}
