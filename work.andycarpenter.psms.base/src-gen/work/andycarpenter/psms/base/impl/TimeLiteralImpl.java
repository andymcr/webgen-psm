 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.TimeLiteralImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link work.andycarpenter.psms.base.impl.TimeLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeLiteralImpl extends MinimalEObjectImpl.Container implements TimeLiteral {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.TIME_LITERAL;
	}
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.TIME_LITERAL__SUFFIXES);
		}
		return suffixes;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.TIME_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.TIME_LITERAL__SUFFIXES:
				return getSuffixes();
			case BasePackage.TIME_LITERAL__VALUE:
				return getValue();
		}
