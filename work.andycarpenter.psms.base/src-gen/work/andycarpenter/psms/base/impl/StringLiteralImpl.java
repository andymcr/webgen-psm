 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.StringLiteralImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link work.andycarpenter.psms.base.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralImpl extends MinimalEObjectImpl.Container implements StringLiteral {
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.STRING_LITERAL__SUFFIXES);
		}
		return suffixes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.STRING_LITERAL__SUFFIXES:
				return getSuffixes();
