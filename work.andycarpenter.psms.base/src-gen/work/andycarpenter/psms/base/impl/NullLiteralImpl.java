 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.NullLiteralImpl#getSuffixes <em>Suffixes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullLiteralImpl extends MinimalEObjectImpl.Container implements NullLiteral {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.NULL_LITERAL;
	}
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.NULL_LITERAL__SUFFIXES);
		}
		return suffixes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.NULL_LITERAL__SUFFIXES:
				return getSuffixes();
		}
