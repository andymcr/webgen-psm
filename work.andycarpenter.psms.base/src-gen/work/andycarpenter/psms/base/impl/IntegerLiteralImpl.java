 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.psms.base.impl.IntegerLiteralImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link work.andycarpenter.psms.base.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerLiteralImpl extends MinimalEObjectImpl.Container implements IntegerLiteral {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.INTEGER_LITERAL;
	}
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeEList<String>(String.class, this, BasePackage.INTEGER_LITERAL__SUFFIXES);
		}
		return suffixes;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.INTEGER_LITERAL__VALUE, oldValue, value));
	}
