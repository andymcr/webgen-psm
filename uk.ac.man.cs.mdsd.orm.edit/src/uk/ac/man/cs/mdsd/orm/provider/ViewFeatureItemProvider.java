...
import uk.ac.man.cs.mdsd.orm.ViewFeature;

/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.orm.ViewFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewFeatureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrmPackage.Literals.VIEW_FEATURE__ALIAS,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ViewFeature.class)) {
			case OrmPackage.VIEW_FEATURE__ALIAS:
