...
public class ViewFeatureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewFeature_includedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewFeature_includedBy_feature", "_UI_ViewFeature_type"),
				 OrmPackage.Literals.VIEW_FEATURE__INCLUDED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((ViewFeature)object).getAlias();
