...
import work.andycarpenter.psms.orm.EncapsulatedFeature;
import work.andycarpenter.psms.orm.OrmPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.psms.orm.EncapsulatedFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EncapsulatedFeatureItemProvider extends ViewFeatureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OrmPackage.Literals.ENCAPSULATED_FEATURE__COLUMN_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((EncapsulatedFeature)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EncapsulatedFeature.class)) {
			case OrmPackage.ENCAPSULATED_FEATURE__COLUMN_NAME:
