...
import work.andycarpenter.metamodel.base.ConstantReference;

import work.andycarpenter.metamodel.expression.ExpressionPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.base.ConstantReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BasePackage.Literals.CONSTANT_REFERENCE__VALUE,
				 true,
				 false,
				 true,
				 null,
