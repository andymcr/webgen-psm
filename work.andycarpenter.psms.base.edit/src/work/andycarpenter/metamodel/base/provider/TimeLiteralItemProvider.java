...
import work.andycarpenter.metamodel.base.TimeLiteral;

import work.andycarpenter.metamodel.expression.ExpressionPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.base.TimeLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BasePackage.Literals.TIME_LITERAL__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
