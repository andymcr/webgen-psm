...
import work.andycarpenter.metamodel.base.IntegerLiteral;

import work.andycarpenter.metamodel.expression.ExpressionPackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.base.IntegerLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BasePackage.Literals.INTEGER_LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerLiteral.class)) {
			case BasePackage.INTEGER_LITERAL__SUFFIXES:
			case BasePackage.INTEGER_LITERAL__VALUE:
