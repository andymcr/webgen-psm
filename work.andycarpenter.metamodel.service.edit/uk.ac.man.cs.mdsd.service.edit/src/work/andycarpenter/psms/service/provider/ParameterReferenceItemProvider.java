...
import work.andycarpenter.psms.service.ParameterReference;
import work.andycarpenter.psms.service.ServicePackage;

/**
 * This is the item provider adapter for a {@link work.andycarpenter.psms.service.ParameterReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServicePackage.Literals.PARAMETER_REFERENCE__PARAMETER,
				 true,
				 false,
				 true,
				 null,
