...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.metamodel.expression.PredicateComparisonOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PredicateComparisonOperatorItemProvider extends PredicateItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionPackage.Literals.PREDICATE_COMPARISON_OPERATOR__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionPackage.Literals.PREDICATE_COMPARISON_OPERATOR__LEFT);
			childrenFeatures.add(ExpressionPackage.Literals.PREDICATE_COMPARISON_OPERATOR__RIGHT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PredicateComparisonOperator.class)) {
			...
			case ExpressionPackage.PREDICATE_COMPARISON_OPERATOR__RIGHT:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ExpressionPackage.Literals.PREDICATE_COMPARISON_OPERATOR__LEFT ||
			childFeature == ExpressionPackage.Literals.PREDICATE_COMPARISON_OPERATOR__RIGHT;
