...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Unit Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class UnitAttributeTest extends UnitFeatureTest {
	...
	public static void main(String[] args) {
		TestRunner.run(UnitAttributeTest.class);
	}

	/**
	 * Constructs a new Unit Attribute test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public UnitAttributeTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Unit Attribute test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected UnitAttribute getFixture() {
		return (UnitAttribute)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(WafFactory.eINSTANCE.createUnitAttribute());
	}
