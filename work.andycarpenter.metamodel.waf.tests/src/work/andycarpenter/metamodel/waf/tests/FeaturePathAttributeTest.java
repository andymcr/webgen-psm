...
import work.andycarpenter.metamodel.waf.FeaturePathAttribute;
import work.andycarpenter.metamodel.waf.WafFactory;

/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Feature Path Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class FeaturePathAttributeTest extends PathAttributeTest {
	...
	public static void main(String[] args) {
		TestRunner.run(FeaturePathAttributeTest.class);
	}

	/**
	 * Constructs a new Feature Path Attribute test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public FeaturePathAttributeTest(String name) {
		super(name);
	}

	/**
	 * Returns the fixture for this Feature Path Attribute test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	protected FeaturePathAttribute getFixture() {
		return (FeaturePathAttribute)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(WafFactory.eINSTANCE.createFeaturePathAttribute());
	}
